...
_DHCPTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='deprecated_server', index=3, number=3,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
