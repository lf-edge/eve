...
func (ZSrvType) EnumDescriptor() ([]byte, []int) { return fileDescriptor7, []int{0} }
...
func (*ServiceOpaqueConfig) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{0} }
...
func (*ServiceLispConfig) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{1} }
...
func (*ServiceInstanceConfig) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{2} }
...
func init() { proto.RegisterFile("service.proto", fileDescriptor7) }
