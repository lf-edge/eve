...
_IMAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='iformat', full_name='Image.iformat', index=4,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='siginfo', full_name='Image.siginfo', index=5,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='dsId', full_name='Image.dsId', index=6,
