...
_NETWORKINSTANCECONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='devlink', full_name='NetworkInstanceConfig.devlink', index=4,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='entProxy', full_name='NetworkInstanceConfig.entProxy', index=8,
...
_NETWORKINSTANCECONFIG.fields_by_name['devlink'].message_type = devcommon__pb2._ADAPTER
...
_NETWORKINSTANCECONFIG.fields_by_name['entProxy'].message_type = netcmn__pb2._PROXYCONFIG
