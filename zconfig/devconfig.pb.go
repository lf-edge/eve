...
import appconfig "github.com/zededa/api/zconfig"
import baseosconfig "github.com/zededa/api/zconfig"
import netconfig "github.com/zededa/api/zconfig"
import storage "github.com/zededa/api/zconfig"
import service "github.com/zededa/api/zconfig"
...
func (SWAdapterType) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (*MapServer) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (*ZedServer) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (*DeviceLispDetails) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (*DeviceOpsCmd) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (*SWAdapterParams) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func (*SystemAdapter) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
...
type EdgeDevConfig struct {
	...
	Apps               []*appconfig.AppInstanceConfig   `protobuf:"bytes,4,rep,name=apps" json:"apps,omitempty"`
	Networks           []*netconfig.NetworkConfig       `protobuf:"bytes,5,rep,name=networks" json:"networks,omitempty"`
	Datastores         []*storage.DatastoreConfig       `protobuf:"bytes,6,rep,name=datastores" json:"datastores,omitempty"`
	LispInfo           *DeviceLispDetails               `protobuf:"bytes,7,opt,name=lispInfo" json:"lispInfo,omitempty"`
	Base               []*baseosconfig.BaseOSConfig     `protobuf:"bytes,8,rep,name=base" json:"base,omitempty"`
	...
	Services           []*service.ServiceInstanceConfig `protobuf:"bytes,13,rep,name=services" json:"services,omitempty"`
}
...
func (*EdgeDevConfig) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func (m *EdgeDevConfig) GetApps() []*appconfig.AppInstanceConfig {
	if m != nil {
		return m.Apps
	}
	return nil
...
func (m *EdgeDevConfig) GetNetworks() []*netconfig.NetworkConfig {
	if m != nil {
		return m.Networks
	}
	return nil
...
func (m *EdgeDevConfig) GetDatastores() []*storage.DatastoreConfig {
	if m != nil {
		return m.Datastores
	}
	return nil
...
func (m *EdgeDevConfig) GetBase() []*baseosconfig.BaseOSConfig {
	if m != nil {
		return m.Base
	}
	return nil
...
func (m *EdgeDevConfig) GetServices() []*service.ServiceInstanceConfig {
	if m != nil {
		return m.Services
	}
	return nil
...
func (*ConfigItem) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
func (*ConfigResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }
...
func init() { proto.RegisterFile("devconfig.proto", fileDescriptor0) }
