...
func (ProxyProto) EnumDescriptor() ([]byte, []int) { return fileDescriptor3, []int{0} }
...
func (SWAdapterType) EnumDescriptor() ([]byte, []int) { return fileDescriptor3, []int{1} }
...
func (*ProxyServer) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{4} }
...
type ProxyConfig struct {
	...
	Proxies    []*ProxyServer `protobuf:"bytes,1,rep,name=proxies" json:"proxies,omitempty"`
...
func (*ProxyConfig) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{5} }
...
func (*SWAdapterParams) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{6} }
...
type SystemAdapter struct {
	...
	// enterprise proxy
	EntProxy *ProxyConfig `protobuf:"bytes,6,opt,name=entProxy" json:"entProxy,omitempty"`
}
...
func (*SystemAdapter) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{7} }
...
func (m *SystemAdapter) GetEntProxy() *ProxyConfig {
	if m != nil {
		return m.EntProxy
	}
	return nil
...
func (*EdgeDevConfig) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{8} }
...
func (*ConfigItem) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{9} }
...
func (*ConfigRequest) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{10} }
...
func (*ConfigResponse) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{11} }
...
var fileDescriptor3 = []byte{
	...
	,
}
