...
carries no support status. It describes the support the Project EVE community provides; a
downstream vendor may offer different support for its EVE-based product.
