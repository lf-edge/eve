...
func TestBlockRoundTrip(t *testing.T) {
	...
	if res := Block(b, 7, 3, testBlockSize); res.Status != BlockOK {
...
func TestBlockZeroed(t *testing.T) {
	...
	if res := Block(b, 1, 0, testBlockSize); res.Status != BlockZeroed {
...
func TestBlockGarbage(t *testing.T) {
	...
	if res := Block(b, 1, 0, testBlockSize); res.Status != BlockGarbage {
...
func TestBlockMisplaced(t *testing.T) {
	...
	if res := Block(b2, 1, 0, testBlockSize); res.Status != BlockMisplaced || res.FoundIndex != 5 {
...
func TestBlockTorn(t *testing.T) {
	...
	b[headerLen+10] ^= 0xff
	if res := Block(b, 1, 0, testBlockSize); res.Status != BlockTorn {
