...
// --------------------
//   - Three purgeDeviceRequirements (fixtures_test.go) devices, called with
//     HypervisorKubevirt - same fresh-image/vcpu-cap setup as the other
//     Kubevirt tests in this suite,
//     following tests/cluster/cluster_test.go's TestThreeNodesCluster
//     topology.
