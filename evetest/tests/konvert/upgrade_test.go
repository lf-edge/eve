...
// happy path of it -- no repartition involved, the flavor the only variable.
// Both images are the build under test: the relaxation is in no release, so a
// released source would refuse the update whatever it was offered.
//
// Phases:
