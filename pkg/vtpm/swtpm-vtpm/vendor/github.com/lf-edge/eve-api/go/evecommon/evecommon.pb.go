...
const (
	...
	BootOrder_BOOT_ORDER_UNSPECIFIED BootOrder = 0
	// Enable USB boot priority - OVMF will prioritize USB devices in boot order.
	BootOrder_BOOT_ORDER_USB BootOrder = 1
	// Disable USB boot - OVMF will deprioritize USB devices in boot order.
	BootOrder_BOOT_ORDER_NOUSB BootOrder = 2
)

// Enum value maps for BootOrder.
var (
	BootOrder_name = map[int32]string{
		0: "BOOT_ORDER_UNSPECIFIED",
		1: "BOOT_ORDER_USB",
		2: "BOOT_ORDER_NOUSB",
	}
	BootOrder_value = map[string]int32{
...
func (x BootOrder) Enum() *BootOrder {
	p := new(BootOrder)
	*p = x
	return p
}
...
func (BootOrder) Descriptor() protoreflect.EnumDescriptor {
	return file_evecommon_evecommon_proto_enumTypes[1].Descriptor()
}

func (BootOrder) Type() protoreflect.EnumType {
	return &file_evecommon_evecommon_proto_enumTypes[1]
}

func (x BootOrder) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use BootOrder.Descriptor instead.
func (BootOrder) EnumDescriptor() ([]byte, []int) {
...
var file_evecommon_evecommon_proto_rawDesc = []byte{
	...
	0x42, 0x59, 0x54, 0x45, 0x53, 0x10, 0x02, 0x2a, 0x51, 0x0a, 0x09, 0x42, 0x6f, 0x6f, 0x74, 0x4f,
	0x72, 0x64, 0x65, 0x72, 0x12, 0x1a, 0x0a, 0x16, 0x42, 0x4f, 0x4f, 0x54, 0x5f, 0x4f, 0x52, 0x44,
	0x45, 0x52, 0x5f, 0x55, 0x4e, 0x53, 0x50, 0x45, 0x43, 0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00,
	0x12, 0x12, 0x0a, 0x0e, 0x42, 0x4f, 0x4f, 0x54, 0x5f, 0x4f, 0x52, 0x44, 0x45, 0x52, 0x5f, 0x55,
	0x53, 0x42, 0x10, 0x01, 0x12, 0x14, 0x0a, 0x10, 0x42, 0x4f, 0x4f, 0x54, 0x5f, 0x4f, 0x52, 0x44,
	0x45, 0x52, 0x5f, 0x4e, 0x4f, 0x55, 0x53, 0x42, 0x10, 0x02, 0x42, 0x4d, 0x0a, 0x15, 0x6f, 0x72,
...
var file_evecommon_evecommon_proto_goTypes = []interface{}{
	...
	(BootOrder)(0),          // 1: org.lfedge.eve.common.BootOrder
