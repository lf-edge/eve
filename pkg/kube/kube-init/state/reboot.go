...
// in the format the on-disk contract specifies:
//
//	[2026-05-15 14:23:45]: BootReasonKubeTransition, <reason>
//
// (Note the leading space — required by the format contract.)
// The file is fsync'd before close so a reboot triggered immediately
// after this call still finds the line on disk.
