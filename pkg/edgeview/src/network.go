...
func isEveKVNCRequest(opt string, appUUID string) bool {
	// Check if this device is running eve-k (Kubernetes hypervisor)
	if !isHVTypeKube || !strings.Contains(opt, ":4822") || appUUID == "" {
		return false
	}
