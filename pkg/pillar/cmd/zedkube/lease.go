...
func (z *zedkube) publishLeaseElectionChange() {
	// Publish the change in leader
	leaseinfo := types.KubeLeaseInfo{
		InLeaseElection: z.inKubeLeaderElection.Load(),
	...
	z.pubLeaseLeaderInfo.Publish("global", leaseinfo)
}
