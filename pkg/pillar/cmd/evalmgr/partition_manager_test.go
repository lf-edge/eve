...
func TestPartitionManagerWithMockStore(t *testing.T) {
	...
	failed, err := pm.FindFailedPartitions(nil)
	require.NoError(t, err)
...
func TestNewArchitectureCompleteFlow(t *testing.T) {
	...
	// Test each partition in sequence
