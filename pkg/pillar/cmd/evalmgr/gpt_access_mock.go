...
func (m *MockGptAccess) GetPartitionAttributes(log *base.LogObject, partition string) (uint16, error) {
...
func (m *MockGptAccess) SetPartitionAttributes(log *base.LogObject, partition string, attr uint16) error {
