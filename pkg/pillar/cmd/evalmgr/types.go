...
type PartitionManagerInterface interface {
	...
	MarkGood(log *base.LogObject, partition string) error
	...
	MarkBad(log *base.LogObject, partition string) error
	...
	SetBest(log *base.LogObject, partition string) error
	...
	FindFailedPartitions(log *base.LogObject) ([]string, error)
}
...
type GptAttributeAccess interface {
	...
	GetPartitionAttributes(log *base.LogObject, partition string) (uint16, error)
	...
	SetPartitionAttributes(log *base.LogObject, partition string, attr uint16) error
