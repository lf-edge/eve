...
func (msrv *Msrv) handleSigner(cloudClient *cloudconn.Client) func(http.ResponseWriter, *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		resp, err := cloudClient.AddAuthentication(bytes.NewBuffer(payload), false)
		if err != nil {
