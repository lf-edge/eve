...
type mgmtProxyContext struct {
	...
	// startProxyAuthLoader. Unset (nil) until then, which checkProxyAuth
	...
	// startProxyAuthLoader. Unset (nil) until then, which the listener's
...
func Run(ps *pubsub.PubSub, loggerArg *logrus.Logger, logArg *base.LogObject,
	...
	// startProxyAuthLoader — any handshake attempted before the cert is
