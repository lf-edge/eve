...
func trySendToController(attestReq *attest.ZAttestReq, attestCtx *attestContext) (cloudconn.SendRetval, error) {
	...
	rv, err := cloudClient.SendOnAllIntf(ctxWork, attestURL, buf,
