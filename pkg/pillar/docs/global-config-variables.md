...
| network.allow.wwan.baseos.download | "enabled" or "disabled" | enabled | allow app image download over non-free ports like LTE |
| network.allow.wwan.cert.download | "enabled" or "disabled" | enabled | allow app image download over non-free ports like LTE |
