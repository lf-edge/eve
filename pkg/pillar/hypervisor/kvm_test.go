...
func TestCreateDomConfigOnlyCom1(t *testing.T) {
	...
	t.Run("amd64", func(t *testing.T) {
		...
		expected := `# This file is automatically generated by domainmgr
[msg]
  timestamp = "on"
...
`
		if string(result) != expected {
			t.Errorf("got an unexpected resulting config %s diff %s",
				string(result), cmp.Diff(expected, string(result)))
		}
	})
...
func TestCreateDomConfigDualOCI(t *testing.T) {
	id, err := uuid.NewV4()
	if err != nil {
		t.Errorf("NewV4 failed: %v", err)
	}
	...
	disks := []types.DiskStatus{
		{Format: zconfig.Format_CONTAINER, FileLocation: "/foo/container", Devtype: "9P"},
		{Format: zconfig.Format_CONTAINER, FileLocation: "/foo/volume", Devtype: "9P"},
	}
	status := types.DomainStatus{
		DiskStatusList: disks,
		ContainerList:  make([]types.DomainContainerStatus, 2),
