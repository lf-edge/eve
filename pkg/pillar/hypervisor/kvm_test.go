...
func TestCreateDomConfigOnlyCom1(t *testing.T) {
	...
	t.Run("amd64", func(t *testing.T) {
		conf.Seek(0, 0)
		if err := kvmIntel.CreateDomConfig(DefaultDomainName, config, types.DomainStatus{}, disks, &aa, conf); err != nil {
...
`, DefaultUUID, DefaultDomainName, DefaultDomainName, DefaultDomainName)
	...
	t.Run("arm64", func(t *testing.T) {
		conf.Seek(0, 0)
		if err := kvmArm.CreateDomConfig(DefaultDomainName, config, types.DomainStatus{}, disks, &aa, conf); err != nil {
			t.Errorf("CreateDomConfig failed %v", err)
		}
		defer os.Truncate(conf.Name(), 0)
...
`, DefaultDomainName, DefaultDomainName, DefaultDomainName)
	...
	t.Run("amd64-legacy", func(t *testing.T) {
		conf.Seek(0, 0)
		if err := kvmIntel.CreateDomConfig(DefaultDomainName, config, types.DomainStatus{}, disksLegacy, &aa, conf); err != nil {
			t.Errorf("CreateDomConfig failed %v", err)
		}
		defer os.Truncate(conf.Name(), 0)
...
func TestCreateDom(t *testing.T) {
	...
	ioutil.WriteFile(conf.Name(), []byte(fmt.Sprintf(`# This file is automatically generated by domainmgr
[msg]
  timestamp = "on"
