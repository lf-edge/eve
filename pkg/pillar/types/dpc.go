...
type DhcpConfig struct {
	...
	AddrSubnet string      `json:",omitempty"` // In CIDR e.g., 192.168.1.44/24
	Gateway    net.IP      `json:",omitempty"`
	DomainName string      `json:",omitempty"`
	NTPServer  net.IP      `json:",omitempty"`
...
type NetworkXObjectConfig struct {
	...
	Dhcp            DhcpType       `json:",omitempty"` // If DhcpTypeStatic or DhcpTypeClient use below
