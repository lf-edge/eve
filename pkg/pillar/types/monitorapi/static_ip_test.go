...
func fixtures() map[string]any {
	...
	return map[string]any{
		...
		"device_status.json": DeviceStatus{
			...
			ConfigStatus:  ConfigGetStatusSuccess,
			DeviceState:   DeviceStateOnline,
			BootReason:    BootReasonRebootCmd,
			RebootReason:  "scheduled",
			AttestState:   AttestStateComplete,
