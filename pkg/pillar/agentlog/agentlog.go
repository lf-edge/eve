...
var listenDebugRunning bool
var listenDebugRunningMutex sync.Mutex

func listenDebug(log *base.LogObject, agentName string) {
	listenDebugRunningMutex.Lock()
	if listenDebugRunning {
		return
	}
	listenDebugRunning = true
	listenDebugRunningMutex.Unlock()
