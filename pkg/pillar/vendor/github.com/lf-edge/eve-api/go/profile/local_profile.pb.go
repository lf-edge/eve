...
// boot order for an application. This is published by EVE to LPS via the
// POST /api/v1/appbootinfo endpoint to help operators understand which setting
// "won" when multiple sources are configured.
...
func (BootOrderSource) Descriptor() protoreflect.EnumDescriptor {
	return file_profile_local_profile_proto_enumTypes[0].Descriptor()
}

func (BootOrderSource) Type() protoreflect.EnumType {
	return &file_profile_local_profile_proto_enumTypes[0]
}

func (x BootOrderSource) Number() protoreflect.EnumNumber {
...
var (
	LocalDevCmd_Command_name = map[int32]string{
		...
		// Duplicate value: 2: "COMMAND_SHUTDOWN_POWEROFF",
...
func (LocalDevCmd_Command) Descriptor() protoreflect.EnumDescriptor {
	return file_profile_local_profile_proto_enumTypes[2].Descriptor()
}

func (LocalDevCmd_Command) Type() protoreflect.EnumType {
	return &file_profile_local_profile_proto_enumTypes[2]
}
...
// This message is part of the AppBootConfigList returned by LPS in response to
...
// Returned by LPS in response to POST /api/v1/appbootinfo (when status code is 200).
// EVE posts AppBootInfoList with current boot status, LPS responds with this config.
//
// Persistence behavior:
// EVE caches and persists the received configuration to disk. This is needed
// to handle EVE reboots: since LPS runs as a VM on the same device, it's
// unavailable until EVE and the LPS VM come back up. The persisted cache
// ensures boot order settings are applied immediately when VMs start.
//
//   - LPS unavailable (during EVE boot): Cache preserved, persisted config applied.
//   - HTTP 404: Cache cleared; all apps reset to default. This means "LPS has
//     no config for this device" - fall back to Controller/Device settings.
//   - HTTP 204: Cache preserved (no changes requested).
//   - HTTP 200 with apps: Cache updated. Apps in response get new values;
//     apps NOT in response are removed from cache and reset to default.
...
// AppBootInfo contains the effective boot order and its source for a single
// application instance. This is published by EVE to LPS via POST /api/v1/appbootinfo.
type AppBootInfo struct {
	...
	BootOrder evecommon.BootOrder `protobuf:"varint,3,opt,name=boot_order,json=bootOrder,proto3,enum=org.lfedge.eve.common.BootOrder" json:"boot_order,omitempty"`
...
func (x *AppBootInfo) Reset() {
	*x = AppBootInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_profile_local_profile_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AppBootInfo) Descriptor() ([]byte, []int) {
	return file_profile_local_profile_proto_rawDescGZIP(), []int{12}
}
...
func (x *AppBootInfo) GetSource() BootOrderSource {
	...
	return BootOrderSource_BOOT_ORDER_SOURCE_UNSPECIFIED
}

// AppBootInfoList is sent by EVE to LPS via POST /api/v1/appbootinfo.
// This allows LPS to display the effective boot order and its source for each
// application, helping operators understand which configuration "won" when
// multiple sources (LPS, Controller API, Device Property) are configured.
//
// LPS responds with AppBootConfigList containing new boot configurations:
// - HTTP 200: Response contains AppBootConfigList with new config to apply.
// - HTTP 204: No changes; EVE preserves current cached config.
// - HTTP 404: Not implemented or no config for this device; cache cleared.
...
func (x *AppBootInfoList) Reset() {
	*x = AppBootInfoList{}
	if protoimpl.UnsafeEnabled {
		mi := &file_profile_local_profile_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AppBootInfoList) Descriptor() ([]byte, []int) {
	return file_profile_local_profile_proto_rawDescGZIP(), []int{13}
}

func (x *AppBootInfoList) GetAppsBootInfo() []*AppBootInfo {
	if x != nil {
		return x.AppsBootInfo
	}
	return nil
}
...
var file_profile_local_profile_proto_rawDesc = []byte{
	...
	,
	...
	0x6c, 0x6c, 0x75, 0x6c, 0x61, 0x72, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x52, 0x0f, 0x63, 0x65,
	0x6c, 0x6c, 0x75, 0x6c, 0x61, 0x72, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x22, 0xc0, 0x02,
	0x0a, 0x0e, 0x43, 0x65, 0x6c, 0x6c, 0x75, 0x6c, 0x61, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x12, 0x22, 0x0a, 0x0c, 0x6c, 0x6f, 0x67, 0x69, 0x63, 0x61, 0x6c, 0x6c, 0x61, 0x62, 0x65, 0x6c,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x6c, 0x6f, 0x67, 0x69, 0x63, 0x61, 0x6c, 0x6c,
	0x61, 0x62, 0x65, 0x6c, 0x12, 0x40, 0x0a, 0x06, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x18, 0x02,
	...
	,
	...
	0x22, 0x55, 0x0a, 0x0b, 0x52, 0x61, 0x64, 0x69, 0x6f, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12,
	...
	,
	...
	0x03, 0x65, 0x72, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x6f, 0x72, 0x67,
	...
	,
	...
	,
	...
	0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x12, 0x64, 0x0a, 0x18, 0x6d,
	0x61, 0x69, 0x6e, 0x74, 0x65, 0x6e, 0x61, 0x6e, 0x63, 0x65, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x5f,
	0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x2a, 0x2e,
	...
	0x73, 0x12, 0x37, 0x0a, 0x09, 0x62, 0x6f, 0x6f, 0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70,
	0x52, 0x08, 0x62, 0x6f, 0x6f, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x49, 0x0a, 0x10, 0x6c, 0x61,
	0x73, 0x74, 0x5f, 0x62, 0x6f, 0x6f, 0x74, 0x5f, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x05,
	...
	,
	...
	,
	...
	0x79, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x3f, 0x0a, 0x0a, 0x62, 0x6f, 0x6f, 0x74, 0x5f, 0x6f, 0x72,
	0x64, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x6f, 0x72, 0x67, 0x2e,
	0x6c, 0x66, 0x65, 0x64, 0x67, 0x65, 0x2e, 0x65, 0x76, 0x65, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	0x6e, 0x2e, 0x42, 0x6f, 0x6f, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x09, 0x62, 0x6f, 0x6f,
	0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x3f, 0x0a, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	...
	,
...
var file_profile_local_profile_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_profile_local_profile_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_profile_local_profile_proto_goTypes = []interface{}{
	(BootOrderSource)(0),             // 0: org.lfedge.eve.profile.BootOrderSource
	(AppCommand_Command)(0),          // 1: org.lfedge.eve.profile.AppCommand.Command
	(LocalDevCmd_Command)(0),         // 2: org.lfedge.eve.profile.LocalDevCmd.Command
	(*LocalProfile)(nil),             // 3: org.lfedge.eve.profile.LocalProfile
	(*RadioStatus)(nil),              // 4: org.lfedge.eve.profile.RadioStatus
	(*CellularStatus)(nil),           // 5: org.lfedge.eve.profile.CellularStatus
	(*RadioConfig)(nil),              // 6: org.lfedge.eve.profile.RadioConfig
	(*LocalAppInfoList)(nil),         // 7: org.lfedge.eve.profile.LocalAppInfoList
	(*LocalAppInfo)(nil),             // 8: org.lfedge.eve.profile.LocalAppInfo
	(*LocalAppCmdList)(nil),          // 9: org.lfedge.eve.profile.LocalAppCmdList
	(*AppCommand)(nil),               // 10: org.lfedge.eve.profile.AppCommand
	(*LocalDevInfo)(nil),             // 11: org.lfedge.eve.profile.LocalDevInfo
	(*LocalDevCmd)(nil),              // 12: org.lfedge.eve.profile.LocalDevCmd
	(*AppBootConfig)(nil),            // 13: org.lfedge.eve.profile.AppBootConfig
	(*AppBootConfigList)(nil),        // 14: org.lfedge.eve.profile.AppBootConfigList
	(*AppBootInfo)(nil),              // 15: org.lfedge.eve.profile.AppBootInfo
	(*AppBootInfoList)(nil),          // 16: org.lfedge.eve.profile.AppBootInfoList
	(*metrics.CellularMetric)(nil),   // 17: org.lfedge.eve.metrics.CellularMetric
	(*info.ZCellularModuleInfo)(nil), // 18: org.lfedge.eve.info.ZCellularModuleInfo
	(*info.ZSimcardInfo)(nil),        // 19: org.lfedge.eve.info.ZSimcardInfo
	(*info.ZCellularProvider)(nil),   // 20: org.lfedge.eve.info.ZCellularProvider
	(*info.ErrorInfo)(nil),           // 21: org.lfedge.eve.info.ErrorInfo
	(info.ZSwState)(0),               // 22: org.lfedge.eve.info.ZSwState
	(info.ZDeviceState)(0),           // 23: org.lfedge.eve.info.ZDeviceState
	(info.MaintenanceModeReason)(0),  // 24: org.lfedge.eve.info.MaintenanceModeReason
	(*timestamppb.Timestamp)(nil),    // 25: google.protobuf.Timestamp
	(info.BootReason)(0),             // 26: org.lfedge.eve.info.BootReason
	(evecommon.BootOrder)(0),         // 27: org.lfedge.eve.common.BootOrder
}
var file_profile_local_profile_proto_depIdxs = []int32{
	5,  // 0: org.lfedge.eve.profile.RadioStatus.cellular_status:type_name -> org.lfedge.eve.profile.CellularStatus
	17, // 1: org.lfedge.eve.profile.RadioStatus.cellular_metrics:type_name -> org.lfedge.eve.metrics.CellularMetric
	18, // 2: org.lfedge.eve.profile.CellularStatus.module:type_name -> org.lfedge.eve.info.ZCellularModuleInfo
	19, // 3: org.lfedge.eve.profile.CellularStatus.sim_cards:type_name -> org.lfedge.eve.info.ZSimcardInfo
	20, // 4: org.lfedge.eve.profile.CellularStatus.providers:type_name -> org.lfedge.eve.info.ZCellularProvider
	8,  // 5: org.lfedge.eve.profile.LocalAppInfoList.apps_info:type_name -> org.lfedge.eve.profile.LocalAppInfo
	21, // 6: org.lfedge.eve.profile.LocalAppInfo.err:type_name -> org.lfedge.eve.info.ErrorInfo
	22, // 7: org.lfedge.eve.profile.LocalAppInfo.state:type_name -> org.lfedge.eve.info.ZSwState
	10, // 8: org.lfedge.eve.profile.LocalAppCmdList.app_commands:type_name -> org.lfedge.eve.profile.AppCommand
	1,  // 9: org.lfedge.eve.profile.AppCommand.command:type_name -> org.lfedge.eve.profile.AppCommand.Command
	23, // 10: org.lfedge.eve.profile.LocalDevInfo.state:type_name -> org.lfedge.eve.info.ZDeviceState
	24, // 11: org.lfedge.eve.profile.LocalDevInfo.maintenance_mode_reasons:type_name -> org.lfedge.eve.info.MaintenanceModeReason
	25, // 12: org.lfedge.eve.profile.LocalDevInfo.boot_time:type_name -> google.protobuf.Timestamp
	26, // 13: org.lfedge.eve.profile.LocalDevInfo.last_boot_reason:type_name -> org.lfedge.eve.info.BootReason
	2,  // 14: org.lfedge.eve.profile.LocalDevCmd.command:type_name -> org.lfedge.eve.profile.LocalDevCmd.Command
	27, // 15: org.lfedge.eve.profile.AppBootConfig.usb_boot:type_name -> org.lfedge.eve.common.BootOrder
	13, // 16: org.lfedge.eve.profile.AppBootConfigList.app_configs:type_name -> org.lfedge.eve.profile.AppBootConfig
	27, // 17: org.lfedge.eve.profile.AppBootInfo.boot_order:type_name -> org.lfedge.eve.common.BootOrder
	0,  // 18: org.lfedge.eve.profile.AppBootInfo.source:type_name -> org.lfedge.eve.profile.BootOrderSource
	15, // 19: org.lfedge.eve.profile.AppBootInfoList.apps_boot_info:type_name -> org.lfedge.eve.profile.AppBootInfo
...
func file_profile_local_profile_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_profile_local_profile_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AppBootInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_profile_local_profile_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AppBootInfoList); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
