...
const (
	...
	AffinityType_AFFINITY_TYPE_PREFERRED AffinityType = 0
	// Required - designated_node_id is required to be healthy for
	// app instance to boot, app will not failover to other nodes.
	AffinityType_AFFINITY_TYPE_REQUIRED AffinityType = 2
)

// Enum value maps for AffinityType.
var (
	AffinityType_name = map[int32]string{
		0: "AFFINITY_TYPE_PREFERRED",
		2: "AFFINITY_TYPE_REQUIRED",
	}
	AffinityType_value = map[string]int32{
		"AFFINITY_TYPE_PREFERRED": 0,
		"AFFINITY_TYPE_REQUIRED":  2,
	}
)

func (x AffinityType) Enum() *AffinityType {
	p := new(AffinityType)
	*p = x
	return p
}

func (x AffinityType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (AffinityType) Descriptor() protoreflect.EnumDescriptor {
	return file_config_appconfig_proto_enumTypes[2].Descriptor()
}

func (AffinityType) Type() protoreflect.EnumType {
	return &file_config_appconfig_proto_enumTypes[2]
}

func (x AffinityType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use AffinityType.Descriptor instead.
func (AffinityType) EnumDescriptor() ([]byte, []int) {
...
func (AppRuntimeType) Descriptor() protoreflect.EnumDescriptor {
	return file_config_appconfig_proto_enumTypes[3].Descriptor()
}

func (AppRuntimeType) Type() protoreflect.EnumType {
	return &file_config_appconfig_proto_enumTypes[3]
}
...
type AppInstanceConfig struct {
	...
	Affinity AffinityType `protobuf:"varint,29,opt,name=affinity,proto3,enum=org.lfedge.eve.config.AffinityType" json:"affinity,omitempty"`
}
...
func (x *AppInstanceConfig) GetAffinity() AffinityType {
	if x != nil {
		return x.Affinity
	}
	return AffinityType_AFFINITY_TYPE_PREFERRED
}
...
var file_config_appconfig_proto_rawDesc = []byte{
	...
	0x22, 0xf9, 0x0a, 0x0a, 0x11, 0x41, 0x70, 0x70, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65,
	...
	0x70, 0x65, 0x52, 0x0b, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12,
	0x3f, 0x0a, 0x08, 0x61, 0x66, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x79, 0x18, 0x1d, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x23, 0x2e, 0x6f, 0x72, 0x67, 0x2e, 0x6c, 0x66, 0x65, 0x64, 0x67, 0x65, 0x2e, 0x65,
	0x76, 0x65, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x41, 0x66, 0x66, 0x69, 0x6e, 0x69,
	0x74, 0x79, 0x54, 0x79, 0x70, 0x65, 0x52, 0x08, 0x61, 0x66, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x79,
	...
	0x72, 0x74, 0x10, 0x03, 0x2a, 0x68, 0x0a, 0x0c, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74,
	...
	0x50, 0x45, 0x5f, 0x49, 0x4d, 0x4d, 0x45, 0x44, 0x49, 0x41, 0x54, 0x45, 0x10, 0x02, 0x2a, 0x47,
	0x0a, 0x0c, 0x41, 0x66, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x79, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1b,
	0x0a, 0x17, 0x41, 0x46, 0x46, 0x49, 0x4e, 0x49, 0x54, 0x59, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f,
	0x50, 0x52, 0x45, 0x46, 0x45, 0x52, 0x52, 0x45, 0x44, 0x10, 0x00, 0x12, 0x1a, 0x0a, 0x16, 0x41,
	0x46, 0x46, 0x49, 0x4e, 0x49, 0x54, 0x59, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x52, 0x45, 0x51,
	0x55, 0x49, 0x52, 0x45, 0x44, 0x10, 0x02, 0x2a, 0x4f, 0x0a, 0x0e, 0x41, 0x70, 0x70, 0x52, 0x75,
	0x6e, 0x74, 0x69, 0x6d, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x20, 0x0a, 0x1c, 0x41, 0x50, 0x50,
	...
	0x50, 0x50, 0x5f, 0x52, 0x55, 0x4e, 0x54, 0x49, 0x4d, 0x45, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f,
	0x44, 0x4f, 0x43, 0x4b, 0x45, 0x52, 0x10, 0x01, 0x42, 0x3d, 0x0a, 0x15, 0x6f, 0x72, 0x67, 0x2e,
...
var file_config_appconfig_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
...
var file_config_appconfig_proto_goTypes = []interface{}{
	...
	(AffinityType)(0),             // 2: org.lfedge.eve.config.AffinityType
	(AppRuntimeType)(0),           // 3: org.lfedge.eve.config.AppRuntimeType
	(*InstanceOpsCmd)(nil),        // 4: org.lfedge.eve.config.InstanceOpsCmd
	(*SnapshotDesc)(nil),          // 5: org.lfedge.eve.config.SnapshotDesc
	(*SnapshotConfig)(nil),        // 6: org.lfedge.eve.config.SnapshotConfig
	(*AppInstanceConfig)(nil),     // 7: org.lfedge.eve.config.AppInstanceConfig
	(*PatchEnvelopeRef)(nil),      // 8: org.lfedge.eve.config.PatchEnvelopeRef
	(*VolumeRef)(nil),             // 9: org.lfedge.eve.config.VolumeRef
	(*UUIDandVersion)(nil),        // 10: org.lfedge.eve.config.UUIDandVersion
	(*VmConfig)(nil),              // 11: org.lfedge.eve.config.VmConfig
	(*Drive)(nil),                 // 12: org.lfedge.eve.config.Drive
	(*NetworkAdapter)(nil),        // 13: org.lfedge.eve.config.NetworkAdapter
...
var file_config_appconfig_proto_depIdxs = []int32{
	...
	4,  // 1: org.lfedge.eve.config.SnapshotConfig.rollback_cmd:type_name -> org.lfedge.eve.config.InstanceOpsCmd
	5,  // 2: org.lfedge.eve.config.SnapshotConfig.snapshots:type_name -> org.lfedge.eve.config.SnapshotDesc
	10, // 3: org.lfedge.eve.config.AppInstanceConfig.uuidandversion:type_name -> org.lfedge.eve.config.UUIDandVersion
	11, // 4: org.lfedge.eve.config.AppInstanceConfig.fixedresources:type_name -> org.lfedge.eve.config.VmConfig
	12, // 5: org.lfedge.eve.config.AppInstanceConfig.drives:type_name -> org.lfedge.eve.config.Drive
	13, // 6: org.lfedge.eve.config.AppInstanceConfig.interfaces:type_name -> org.lfedge.eve.config.NetworkAdapter
	14, // 7: org.lfedge.eve.config.AppInstanceConfig.adapters:type_name -> org.lfedge.eve.config.Adapter
	4,  // 8: org.lfedge.eve.config.AppInstanceConfig.restart:type_name -> org.lfedge.eve.config.InstanceOpsCmd
	4,  // 9: org.lfedge.eve.config.AppInstanceConfig.purge:type_name -> org.lfedge.eve.config.InstanceOpsCmd
	15, // 10: org.lfedge.eve.config.AppInstanceConfig.cipherData:type_name -> org.lfedge.eve.common.CipherBlock
	9,  // 11: org.lfedge.eve.config.AppInstanceConfig.volumeRefList:type_name -> org.lfedge.eve.config.VolumeRef
	0,  // 12: org.lfedge.eve.config.AppInstanceConfig.metaDataType:type_name -> org.lfedge.eve.config.MetaDataType
	6,  // 13: org.lfedge.eve.config.AppInstanceConfig.snapshot:type_name -> org.lfedge.eve.config.SnapshotConfig
	8,  // 14: org.lfedge.eve.config.AppInstanceConfig.patchRef:type_name -> org.lfedge.eve.config.PatchEnvelopeRef
	3,  // 15: org.lfedge.eve.config.AppInstanceConfig.runtime_type:type_name -> org.lfedge.eve.config.AppRuntimeType
	2,  // 16: org.lfedge.eve.config.AppInstanceConfig.affinity:type_name -> org.lfedge.eve.config.AffinityType
