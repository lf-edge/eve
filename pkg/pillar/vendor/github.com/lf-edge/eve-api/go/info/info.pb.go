...
// sub-state once it can talk to the controller again. Sub-states for other
// device states can be added here later.
type ZDeviceSubState int32

const (
	ZDeviceSubState_ZDEVICE_SUBSTATE_UNSPECIFIED ZDeviceSubState = 0
	// Pre-flight check of partition geometry and free space.
	ZDeviceSubState_ZDEVICE_SUBSTATE_CONVERT_PREFLIGHT ZDeviceSubState = 1
	// Rebooting into the early-boot resizer to free space (persist must be
	// unmounted to shrink it).
	ZDeviceSubState_ZDEVICE_SUBSTATE_CONVERT_REBOOTING_TO_RESIZE ZDeviceSubState = 2
	// Making space: shrinking the persist filesystem and partition.
	ZDeviceSubState_ZDEVICE_SUBSTATE_CONVERT_MAKING_SPACE ZDeviceSubState = 3
	// Creating the new ESP/IMGA/IMGB partitions in the freed space.
	ZDeviceSubState_ZDEVICE_SUBSTATE_CONVERT_CREATING_PARTITIONS ZDeviceSubState = 4
	// Renaming/reindexing the new partitions over the old (atomic GPT swap).
	ZDeviceSubState_ZDEVICE_SUBSTATE_CONVERT_RENAMING_PARTITIONS ZDeviceSubState = 5
	// Installing the EVE-k (or EVE-kvm) base image into the resized partitions.
	ZDeviceSubState_ZDEVICE_SUBSTATE_CONVERT_INSTALLING ZDeviceSubState = 6
	// Rebooting into the converted EVE flavor.
	ZDeviceSubState_ZDEVICE_SUBSTATE_CONVERT_REBOOTING_TO_TARGET ZDeviceSubState = 7
)
...
var (
	ZDeviceSubState_name = map[int32]string{
		...
		1: "ZDEVICE_SUBSTATE_CONVERT_PREFLIGHT",
		2: "ZDEVICE_SUBSTATE_CONVERT_REBOOTING_TO_RESIZE",
		3: "ZDEVICE_SUBSTATE_CONVERT_MAKING_SPACE",
		4: "ZDEVICE_SUBSTATE_CONVERT_CREATING_PARTITIONS",
		5: "ZDEVICE_SUBSTATE_CONVERT_RENAMING_PARTITIONS",
		6: "ZDEVICE_SUBSTATE_CONVERT_INSTALLING",
		7: "ZDEVICE_SUBSTATE_CONVERT_REBOOTING_TO_TARGET",
	}
	ZDeviceSubState_value = map[string]int32{
		"ZDEVICE_SUBSTATE_UNSPECIFIED":                 0,
		"ZDEVICE_SUBSTATE_CONVERT_PREFLIGHT":           1,
		"ZDEVICE_SUBSTATE_CONVERT_REBOOTING_TO_RESIZE": 2,
		"ZDEVICE_SUBSTATE_CONVERT_MAKING_SPACE":        3,
		"ZDEVICE_SUBSTATE_CONVERT_CREATING_PARTITIONS": 4,
		"ZDEVICE_SUBSTATE_CONVERT_RENAMING_PARTITIONS": 5,
		"ZDEVICE_SUBSTATE_CONVERT_INSTALLING":          6,
		"ZDEVICE_SUBSTATE_CONVERT_REBOOTING_TO_TARGET": 7,
	}
)
...
var file_info_info_proto_rawDesc = []byte{
	...
	0x52, 0x54, 0x49, 0x4e, 0x47, 0x10, 0x09, 0x2a, 0xf7, 0x02, 0x0a, 0x0f, 0x5a, 0x44, 0x65, 0x76,
	...
	0x22, 0x5a, 0x44, 0x45, 0x56, 0x49, 0x43, 0x45, 0x5f, 0x53, 0x55, 0x42, 0x53, 0x54, 0x41, 0x54,
	0x45, 0x5f, 0x43, 0x4f, 0x4e, 0x56, 0x45, 0x52, 0x54, 0x5f, 0x50, 0x52, 0x45, 0x46, 0x4c, 0x49,
	0x47, 0x48, 0x54, 0x10, 0x01, 0x12, 0x30, 0x0a, 0x2c, 0x5a, 0x44, 0x45, 0x56, 0x49, 0x43, 0x45,
	...
	,
