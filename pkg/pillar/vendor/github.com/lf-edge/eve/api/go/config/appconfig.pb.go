...
type AppInstanceConfig struct {
	...
	// container in the order they are listed, e.g., the first VM image
	// will be the root disk.
	VolumeRefs []*VolumeRef `protobuf:"bytes,16,rep,name=volumeRefs,proto3" json:"volumeRefs,omitempty"`
}
...
func (x *AppInstanceConfig) GetVolumeRefs() []*VolumeRef {
	if x != nil {
		return x.VolumeRefs
	}
	return nil
...
var file_config_appconfig_proto_rawDesc = []byte{
	...
	0xd2, 0x04, 0x0a, 0x11, 0x41, 0x70, 0x70, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x43,
	...
	0x74, 0x73, 0x49, 0x50, 0x41, 0x64, 0x64, 0x72, 0x12, 0x2a, 0x0a, 0x0a, 0x76, 0x6f, 0x6c, 0x75,
	0x6d, 0x65, 0x52, 0x65, 0x66, 0x73, 0x18, 0x10, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x56,
	0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x52, 0x65, 0x66, 0x52, 0x0a, 0x76, 0x6f, 0x6c, 0x75, 0x6d, 0x65,
	0x52, 0x65, 0x66, 0x73, 0x22, 0x49, 0x0a, 0x09, 0x56, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x52, 0x65,
	...
	0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x42,
...
var file_config_appconfig_proto_depIdxs = []int32{
	...
	2, // 8: AppInstanceConfig.volumeRefs:type_name -> VolumeRef
