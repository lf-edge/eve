...
type AppInstanceConfig struct {
	...
	// The static IP address assigned on the NetworkAdpater of the App which serves
	// as the local data store server. If this 'localDataStoreIPAddr' is valid,
	// it enables the device datastore config where the FQDN IP address matches this
	// address and to be routed locally inside the device. If a Port map is enabled
	// for external access, that would be a normal inbound access operation for
	// this App to serve the data store remotely also.
	LocalDataStoreIPAddr string `protobuf:"bytes,19,opt,name=localDataStoreIPAddr,proto3" json:"localDataStoreIPAddr,omitempty"`
}
...
func (x *AppInstanceConfig) GetLocalDataStoreIPAddr() string {
	if x != nil {
		return x.LocalDataStoreIPAddr
	}
	return ""
}
...
var file_config_appconfig_proto_rawDesc = []byte{
	...
	0x70, 0x73, 0x54, 0x69, 0x6d, 0x65, 0x22, 0xbe, 0x07, 0x0a, 0x11, 0x41, 0x70, 0x70, 0x49, 0x6e,
	...
	0x69, 0x73, 0x74, 0x12, 0x32, 0x0a, 0x14, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x44, 0x61, 0x74, 0x61,
	0x53, 0x74, 0x6f, 0x72, 0x65, 0x49, 0x50, 0x41, 0x64, 0x64, 0x72, 0x18, 0x13, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x14, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x44, 0x61, 0x74, 0x61, 0x53, 0x74, 0x6f, 0x72,
	0x65, 0x49, 0x50, 0x41, 0x64, 0x64, 0x72, 0x22, 0x66, 0x0a, 0x09, 0x56, 0x6f, 0x6c, 0x75, 0x6d,
	...
	0x69, 0x70, 0x61, 0x72, 0x74, 0x10, 0x03, 0x42, 0x3d, 0x0a, 0x15, 0x6f, 0x72, 0x67, 0x2e, 0x6c,
