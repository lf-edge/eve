...
const (
	...
	ZInfoTypes_Z_INFO_TYPES_CIPHER_INFO ZInfoTypes = 10
)
...
// cipher object type
type CipherObjectType int32

const (
	CipherObjectType_CIPHER_OBJECT_TYPE_INVALID          CipherObjectType = 0
	CipherObjectType_CIPHER_OBJECT_TYPE_CONTEXT          CipherObjectType = 1
	CipherObjectType_CIPHER_OBJECT_TYPE_CONTROLLER_CERT  CipherObjectType = 2
	CipherObjectType_CIPHER_OBJECT_TYPE_NODE_CERT        CipherObjectType = 3
	CipherObjectType_CIPHER_OBJECT_TYPE_NIM_BLOCK        CipherObjectType = 4
	CipherObjectType_CIPHER_OBJECT_TYPE_DOMAINMGR_BLOCK  CipherObjectType = 5
	CipherObjectType_CIPHER_OBJECT_TYPE_DOWNLOADER_BLOCK CipherObjectType = 6
)

// Enum value maps for CipherObjectType.
var (
	CipherObjectType_name = map[int32]string{
		0: "CIPHER_OBJECT_TYPE_INVALID",
		1: "CIPHER_OBJECT_TYPE_CONTEXT",
		2: "CIPHER_OBJECT_TYPE_CONTROLLER_CERT",
		3: "CIPHER_OBJECT_TYPE_NODE_CERT",
		4: "CIPHER_OBJECT_TYPE_NIM_BLOCK",
		5: "CIPHER_OBJECT_TYPE_DOMAINMGR_BLOCK",
		6: "CIPHER_OBJECT_TYPE_DOWNLOADER_BLOCK",
	}
	CipherObjectType_value = map[string]int32{
...
func (x CipherObjectType) Enum() *CipherObjectType {
	p := new(CipherObjectType)
	*p = x
	return p
}

func (x CipherObjectType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CipherObjectType) Descriptor() protoreflect.EnumDescriptor {
	return file_info_info_proto_enumTypes[8].Descriptor()
}

func (CipherObjectType) Type() protoreflect.EnumType {
	return &file_info_info_proto_enumTypes[8]
}

func (x CipherObjectType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CipherObjectType.Descriptor instead.
func (CipherObjectType) EnumDescriptor() ([]byte, []int) {
	return file_info_info_proto_rawDescGZIP(), []int{8}
}

// cipher object event
type CipherObjectEvent int32

const (
	CipherObjectEvent_CIPHER_OBJECT_EVENT_INVALID CipherObjectEvent = 0
	CipherObjectEvent_CIPHER_OBJECT_EVENT_CREATE  CipherObjectEvent = 1
	CipherObjectEvent_CIPHER_OBJECT_EVENT_DELETE  CipherObjectEvent = 2
	CipherObjectEvent_CIPHER_OBJECT_EVENT_MODIFY  CipherObjectEvent = 3
	CipherObjectEvent_CIPHER_OBJECT_EVENT_DECRYPT CipherObjectEvent = 4
)

// Enum value maps for CipherObjectEvent.
var (
	CipherObjectEvent_name = map[int32]string{
		0: "CIPHER_OBJECT_EVENT_INVALID",
		1: "CIPHER_OBJECT_EVENT_CREATE",
		2: "CIPHER_OBJECT_EVENT_DELETE",
		3: "CIPHER_OBJECT_EVENT_MODIFY",
		4: "CIPHER_OBJECT_EVENT_DECRYPT",
	}
	CipherObjectEvent_value = map[string]int32{
...
func (x CipherObjectEvent) Enum() *CipherObjectEvent {
	p := new(CipherObjectEvent)
	*p = x
	return p
}

func (x CipherObjectEvent) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CipherObjectEvent) Descriptor() protoreflect.EnumDescriptor {
	return file_info_info_proto_enumTypes[9].Descriptor()
}

func (CipherObjectEvent) Type() protoreflect.EnumType {
	return &file_info_info_proto_enumTypes[9]
}

func (x CipherObjectEvent) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CipherObjectEvent.Descriptor instead.
func (CipherObjectEvent) EnumDescriptor() ([]byte, []int) {
	return file_info_info_proto_rawDescGZIP(), []int{9}
}

type CipherObjectStatus int32

const (
	CipherObjectStatus_CIPHER_OBJECT_STATUS_INVALID CipherObjectStatus = 0
	CipherObjectStatus_CIPHER_OBJECT_STATUS_SUCCESS CipherObjectStatus = 1
	CipherObjectStatus_CIPHER_OBJECT_STATUS_ERROR   CipherObjectStatus = 2
)

// Enum value maps for CipherObjectStatus.
var (
	CipherObjectStatus_name = map[int32]string{
		0: "CIPHER_OBJECT_STATUS_INVALID",
		1: "CIPHER_OBJECT_STATUS_SUCCESS",
		2: "CIPHER_OBJECT_STATUS_ERROR",
	}
	CipherObjectStatus_value = map[string]int32{
...
func (x CipherObjectStatus) Enum() *CipherObjectStatus {
	p := new(CipherObjectStatus)
	*p = x
	return p
}

func (x CipherObjectStatus) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CipherObjectStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_info_info_proto_enumTypes[10].Descriptor()
}

func (CipherObjectStatus) Type() protoreflect.EnumType {
	return &file_info_info_proto_enumTypes[10]
}

func (x CipherObjectStatus) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CipherObjectStatus.Descriptor instead.
func (CipherObjectStatus) EnumDescriptor() ([]byte, []int) {
...
type ZInfoCipher struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Id     string             `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Type   CipherObjectType   `protobuf:"varint,2,opt,name=type,proto3,enum=CipherObjectType" json:"type,omitempty"`
	Event  CipherObjectEvent  `protobuf:"varint,3,opt,name=event,proto3,enum=CipherObjectEvent" json:"event,omitempty"`
	Status CipherObjectStatus `protobuf:"varint,4,opt,name=status,proto3,enum=CipherObjectStatus" json:"status,omitempty"`
	Err    *ErrorInfo         `protobuf:"bytes,5,opt,name=err,proto3" json:"err,omitempty"`
}

func (x *ZInfoCipher) Reset() {
	*x = ZInfoCipher{}
	if protoimpl.UnsafeEnabled {
...
func (x *ZInfoCipher) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ZInfoCipher) ProtoMessage() {}

func (x *ZInfoCipher) ProtoReflect() protoreflect.Message {
	mi := &file_info_info_proto_msgTypes[39]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ZInfoCipher.ProtoReflect.Descriptor instead.
func (*ZInfoCipher) Descriptor() ([]byte, []int) {
	return file_info_info_proto_rawDescGZIP(), []int{39}
}

func (x *ZInfoCipher) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *ZInfoCipher) GetType() CipherObjectType {
	if x != nil {
		return x.Type
	}
	return CipherObjectType_CIPHER_OBJECT_TYPE_INVALID
}

func (x *ZInfoCipher) GetEvent() CipherObjectEvent {
	if x != nil {
		return x.Event
	}
	return CipherObjectEvent_CIPHER_OBJECT_EVENT_INVALID
}

func (x *ZInfoCipher) GetStatus() CipherObjectStatus {
	if x != nil {
		return x.Status
	}
	return CipherObjectStatus_CIPHER_OBJECT_STATUS_INVALID
}

func (x *ZInfoCipher) GetErr() *ErrorInfo {
	if x != nil {
		return x.Err
	}
	return nil
...
func (x *ZInfoMsg) GetCipherinfo() *ZInfoCipher {
	if x, ok := x.GetInfoContent().(*ZInfoMsg_Cipherinfo); ok {
		return x.Cipherinfo
	}
	return nil
}
...
type ZInfoMsg_Cipherinfo struct {
	Cipherinfo *ZInfoCipher `protobuf:"bytes,16,opt,name=cipherinfo,proto3,oneof"`
}
...
func (*ZInfoMsg_Cipherinfo) isZInfoMsg_InfoContent() {}
...
var file_info_info_proto_rawDesc = []byte{
	...
	0x75, 0x72, 0x53, 0x69, 0x7a, 0x65, 0x42, 0x79, 0x74, 0x65, 0x73, 0x22, 0xbb, 0x02, 0x0a, 0x0b,
	...
	,
	...
	0x0c, 0x63, 0x75, 0x72, 0x53, 0x69, 0x7a, 0x65, 0x42, 0x79, 0x74, 0x65, 0x73, 0x22, 0xf9, 0x02,
	...
	,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xe5, 0x01, 0x0a, 0x09, 0x5a, 0x49,
	...
	0x2f, 0x0a, 0x09, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x11, 0x2e, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x73, 0x52, 0x09, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73,
	0x12, 0x20, 0x0a, 0x05, 0x75, 0x73, 0x61, 0x67, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x0a, 0x2e, 0x55, 0x73, 0x61, 0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x05, 0x75, 0x73, 0x61,
	0x67, 0x65, 0x12, 0x1f, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x09, 0x2e, 0x5a, 0x53, 0x77, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74,
	...
	0x61, 0x67, 0x65, 0x12, 0x1c, 0x0a, 0x03, 0x65, 0x72, 0x72, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x0a, 0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x03, 0x65, 0x72,
	0x72, 0x22, 0x2f, 0x0a, 0x0d, 0x5a, 0x49, 0x6e, 0x66, 0x6f, 0x42, 0x6c, 0x6f, 0x62, 0x4c, 0x69,
	0x73, 0x74, 0x12, 0x1e, 0x0a, 0x04, 0x62, 0x6c, 0x6f, 0x62, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x0a, 0x2e, 0x5a, 0x49, 0x6e, 0x66, 0x6f, 0x42, 0x6c, 0x6f, 0x62, 0x52, 0x04, 0x62, 0x6c,
	0x6f, 0x62, 0x22, 0xb3, 0x03, 0x0a, 0x08, 0x5a, 0x49, 0x6e, 0x66, 0x6f, 0x4d, 0x73, 0x67, 0x12,
	0x21, 0x0a, 0x05, 0x7a, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0b,
	...
	,
	...
	0x96, 0x01, 0x0a, 0x0a, 0x5a, 0x49, 0x6e, 0x66, 0x6f, 0x54, 0x79, 0x70, 0x65, 0x73, 0x12, 0x09,
	...
	0x42, 0x6c, 0x6f, 0x62, 0x4c, 0x69, 0x73, 0x74, 0x10, 0x09, 0x12, 0x1c, 0x0a, 0x18, 0x5a, 0x5f,
	0x49, 0x4e, 0x46, 0x4f, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x53, 0x5f, 0x43, 0x49, 0x50, 0x48, 0x45,
	0x52, 0x5f, 0x49, 0x4e, 0x46, 0x4f, 0x10, 0x0a, 0x2a, 0x86, 0x02, 0x0a, 0x08, 0x5a, 0x53, 0x77,
	...
	0x0f, 0x2a, 0x4e, 0x0a, 0x16, 0x48, 0x77, 0x53, 0x65, 0x63, 0x75, 0x72, 0x69, 0x74, 0x79, 0x4d,
	...
	0x52, 0x45, 0x53, 0x54, 0x5f, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x04, 0x2a, 0x71, 0x0a, 0x0c,
	...
	,
...
var file_info_info_proto_goTypes = []interface{}{
	...
	(CipherObjectType)(0),           // 8: CipherObjectType
	(CipherObjectEvent)(0),          // 9: CipherObjectEvent
	(CipherObjectStatus)(0),         // 10: CipherObjectStatus
	(*DeprecatedMetricItem)(nil),    // 11: deprecatedMetricItem
	(*ZmetIPAssignmentEntry)(nil),   // 12: ZmetIPAssignmentEntry
	(*ZmetVifInfo)(nil),             // 13: ZmetVifInfo
	(*ZioBundle)(nil),               // 14: ZioBundle
	(*IoAddresses)(nil),             // 15: IoAddresses
	(*ZInfoManufacturer)(nil),       // 16: ZInfoManufacturer
	(*ZInfoNetwork)(nil),            // 17: ZInfoNetwork
	(*GeoLoc)(nil),                  // 18: GeoLoc
	(*ZInfoDNS)(nil),                // 19: ZInfoDNS
	(*ZInfoSW)(nil),                 // 20: ZInfoSW
	(*ErrorInfo)(nil),               // 21: ErrorInfo
	(*VaultInfo)(nil),               // 22: VaultInfo
	(*DataSecAtRest)(nil),           // 23: DataSecAtRest
	(*ZInfoConfigItem)(nil),         // 24: ZInfoConfigItem
	(*ZInfoConfigItemStatus)(nil),   // 25: ZInfoConfigItemStatus
	(*ZInfoAppInstance)(nil),        // 26: ZInfoAppInstance
	(*ZInfoDevice)(nil),             // 27: ZInfoDevice
	(*SystemAdapterInfo)(nil),       // 28: SystemAdapterInfo
	(*DevicePortStatus)(nil),        // 29: DevicePortStatus
	(*DevicePort)(nil),              // 30: DevicePort
	(*ProxyStatus)(nil),             // 31: ProxyStatus
	(*ProxyEntry)(nil),              // 32: ProxyEntry
	(*ZInfoDevSW)(nil),              // 33: ZInfoDevSW
	(*ZInfoStorage)(nil),            // 34: ZInfoStorage
	(*ZInfoApp)(nil),                // 35: ZInfoApp
	(*ZInfoVpnLinkInfo)(nil),        // 36: ZInfoVpnLinkInfo
	(*ZInfoVpnLink)(nil),            // 37: ZInfoVpnLink
	(*ZInfoVpnEndPoint)(nil),        // 38: ZInfoVpnEndPoint
	(*ZInfoVpnConn)(nil),            // 39: ZInfoVpnConn
	(*ZInfoVpn)(nil),                // 40: ZInfoVpn
	(*RlocState)(nil),               // 41: RlocState
	(*MapCacheEntry)(nil),           // 42: MapCacheEntry
	(*DatabaseMap)(nil),             // 43: DatabaseMap
	(*DecapKey)(nil),                // 44: DecapKey
	(*ZInfoLisp)(nil),               // 45: ZInfoLisp
	(*ZInfoNetworkInstance)(nil),    // 46: ZInfoNetworkInstance
	(*UsageInfo)(nil),               // 47: UsageInfo
	(*VolumeResources)(nil),         // 48: VolumeResources
	(*ZInfoVolume)(nil),             // 49: ZInfoVolume
	(*ZInfoCipher)(nil),             // 50: ZInfoCipher
	(*ContentResources)(nil),        // 51: ContentResources
	(*ZInfoContentTree)(nil),        // 52: ZInfoContentTree
	(*ZInfoBlob)(nil),               // 53: ZInfoBlob
	(*ZInfoBlobList)(nil),           // 54: ZInfoBlobList
	(*ZInfoMsg)(nil),                // 55: ZInfoMsg
	nil,                             // 56: ZInfoConfigItemStatus.ConfigItemsEntry
	nil,                             // 57: ZInfoConfigItemStatus.UnknownConfigItemsEntry
	(evecommon.PhyIoType)(0),        // 58: org.lfedge.eve.common.PhyIoType
	(evecommon.PhyIoMemberUsage)(0), // 59: org.lfedge.eve.common.PhyIoMemberUsage
...
var file_info_info_proto_depIdxs = []int32{
	...
	58,  // 1: ZioBundle.type:type_name -> org.lfedge.eve.common.PhyIoType
	15,  // 2: ZioBundle.ioAddressList:type_name -> IoAddresses
	59,  // 3: ZioBundle.usage:type_name -> org.lfedge.eve.common.PhyIoMemberUsage
	21,  // 4: ZioBundle.err:type_name -> ErrorInfo
	19,  // 5: ZInfoNetwork.dns:type_name -> ZInfoDNS
	18,  // 6: ZInfoNetwork.location:type_name -> GeoLoc
	21,  // 7: ZInfoNetwork.networkErr:type_name -> ErrorInfo
	31,  // 8: ZInfoNetwork.proxy:type_name -> ProxyStatus
	2,   // 9: ZInfoSW.state:type_name -> ZSwState
	60,  // 10: ErrorInfo.timestamp:type_name -> google.protobuf.Timestamp
	4,   // 11: VaultInfo.status:type_name -> DataSecAtRestStatus
	21,  // 12: VaultInfo.vaultErr:type_name -> ErrorInfo
	4,   // 13: DataSecAtRest.status:type_name -> DataSecAtRestStatus
	22,  // 14: DataSecAtRest.vaultList:type_name -> VaultInfo
	56,  // 15: ZInfoConfigItemStatus.configItems:type_name -> ZInfoConfigItemStatus.ConfigItemsEntry
	57,  // 16: ZInfoConfigItemStatus.unknownConfigItems:type_name -> ZInfoConfigItemStatus.UnknownConfigItemsEntry
	16,  // 17: ZInfoDevice.minfo:type_name -> ZInfoManufacturer
	17,  // 18: ZInfoDevice.network:type_name -> ZInfoNetwork
	14,  // 19: ZInfoDevice.assignableAdapters:type_name -> ZioBundle
	19,  // 20: ZInfoDevice.dns:type_name -> ZInfoDNS
	34,  // 21: ZInfoDevice.storageList:type_name -> ZInfoStorage
	60,  // 22: ZInfoDevice.bootTime:type_name -> google.protobuf.Timestamp
	33,  // 23: ZInfoDevice.swList:type_name -> ZInfoDevSW
	11,  // 24: ZInfoDevice.metricItems:type_name -> deprecatedMetricItem
	60,  // 25: ZInfoDevice.lastRebootTime:type_name -> google.protobuf.Timestamp
	28,  // 26: ZInfoDevice.systemAdapter:type_name -> SystemAdapterInfo
	3,   // 27: ZInfoDevice.HSMStatus:type_name -> HwSecurityModuleStatus
	23,  // 28: ZInfoDevice.dataSecAtRestInfo:type_name -> DataSecAtRest
	25,  // 29: ZInfoDevice.configItemStatus:type_name -> ZInfoConfigItemStatus
	26,  // 30: ZInfoDevice.appInstances:type_name -> ZInfoAppInstance
	29,  // 31: SystemAdapterInfo.status:type_name -> DevicePortStatus
	60,  // 32: DevicePortStatus.timePriority:type_name -> google.protobuf.Timestamp
	60,  // 33: DevicePortStatus.lastFailed:type_name -> google.protobuf.Timestamp
	60,  // 34: DevicePortStatus.lastSucceeded:type_name -> google.protobuf.Timestamp
	30,  // 35: DevicePortStatus.ports:type_name -> DevicePort
	31,  // 36: DevicePort.proxy:type_name -> ProxyStatus
	19,  // 37: DevicePort.dns:type_name -> ZInfoDNS
	18,  // 38: DevicePort.location:type_name -> GeoLoc
	21,  // 39: DevicePort.err:type_name -> ErrorInfo
	59,  // 40: DevicePort.usage:type_name -> org.lfedge.eve.common.PhyIoMemberUsage
	32,  // 41: ProxyStatus.proxies:type_name -> ProxyEntry
	2,   // 42: ZInfoDevSW.status:type_name -> ZSwState
	21,  // 43: ZInfoDevSW.swErr:type_name -> ErrorInfo
	5,   // 44: ZInfoDevSW.userStatus:type_name -> BaseOsStatus
	6,   // 45: ZInfoDevSW.subStatus:type_name -> BaseOsSubStatus
	20,  // 46: ZInfoApp.softwareList:type_name -> ZInfoSW
	60,  // 47: ZInfoApp.bootTime:type_name -> google.protobuf.Timestamp
	14,  // 48: ZInfoApp.assignedAdapters:type_name -> ZioBundle
	21,  // 49: ZInfoApp.appErr:type_name -> ErrorInfo
	2,   // 50: ZInfoApp.state:type_name -> ZSwState
	17,  // 51: ZInfoApp.network:type_name -> ZInfoNetwork
	7,   // 52: ZInfoVpnLink.state:type_name -> ZInfoVpnState
	36,  // 53: ZInfoVpnLink.lInfo:type_name -> ZInfoVpnLinkInfo
	36,  // 54: ZInfoVpnLink.rInfo:type_name -> ZInfoVpnLinkInfo
	7,   // 55: ZInfoVpnConn.state:type_name -> ZInfoVpnState
	38,  // 56: ZInfoVpnConn.lInfo:type_name -> ZInfoVpnEndPoint
	38,  // 57: ZInfoVpnConn.rInfo:type_name -> ZInfoVpnEndPoint
	37,  // 58: ZInfoVpnConn.links:type_name -> ZInfoVpnLink
	39,  // 59: ZInfoVpn.conn:type_name -> ZInfoVpnConn
	41,  // 60: MapCacheEntry.Rlocs:type_name -> RlocState
	42,  // 61: DatabaseMap.MapCacheEntries:type_name -> MapCacheEntry
	43,  // 62: ZInfoLisp.DatabaseMaps:type_name -> DatabaseMap
	44,  // 63: ZInfoLisp.DecapKeys:type_name -> DecapKey
	60,  // 64: ZInfoNetworkInstance.upTimeStamp:type_name -> google.protobuf.Timestamp
	20,  // 65: ZInfoNetworkInstance.softwareList:type_name -> ZInfoSW
	12,  // 66: ZInfoNetworkInstance.ipAssignments:type_name -> ZmetIPAssignmentEntry
	13,  // 67: ZInfoNetworkInstance.vifs:type_name -> ZmetVifInfo
	14,  // 68: ZInfoNetworkInstance.assignedAdapters:type_name -> ZioBundle
	40,  // 69: ZInfoNetworkInstance.vinfo:type_name -> ZInfoVpn
	45,  // 70: ZInfoNetworkInstance.linfo:type_name -> ZInfoLisp
	21,  // 71: ZInfoNetworkInstance.networkErr:type_name -> ErrorInfo
	60,  // 72: UsageInfo.createTime:type_name -> google.protobuf.Timestamp
	60,  // 73: UsageInfo.lastRefcountChangeTime:type_name -> google.protobuf.Timestamp
	47,  // 74: ZInfoVolume.usage:type_name -> UsageInfo
	48,  // 75: ZInfoVolume.resources:type_name -> VolumeResources
	2,   // 76: ZInfoVolume.state:type_name -> ZSwState
	21,  // 77: ZInfoVolume.volumeErr:type_name -> ErrorInfo
	8,   // 78: ZInfoCipher.type:type_name -> CipherObjectType
	9,   // 79: ZInfoCipher.event:type_name -> CipherObjectEvent
	10,  // 80: ZInfoCipher.status:type_name -> CipherObjectStatus
	21,  // 81: ZInfoCipher.err:type_name -> ErrorInfo
	51,  // 82: ZInfoContentTree.resources:type_name -> ContentResources
	47,  // 83: ZInfoContentTree.usage:type_name -> UsageInfo
	2,   // 84: ZInfoContentTree.state:type_name -> ZSwState
	21,  // 85: ZInfoContentTree.err:type_name -> ErrorInfo
	51,  // 86: ZInfoBlob.resources:type_name -> ContentResources
	47,  // 87: ZInfoBlob.usage:type_name -> UsageInfo
	2,   // 88: ZInfoBlob.state:type_name -> ZSwState
	21,  // 89: ZInfoBlob.err:type_name -> ErrorInfo
	53,  // 90: ZInfoBlobList.blob:type_name -> ZInfoBlob
	1,   // 91: ZInfoMsg.ztype:type_name -> ZInfoTypes
	27,  // 92: ZInfoMsg.dinfo:type_name -> ZInfoDevice
	35,  // 93: ZInfoMsg.ainfo:type_name -> ZInfoApp
	46,  // 94: ZInfoMsg.niinfo:type_name -> ZInfoNetworkInstance
	49,  // 95: ZInfoMsg.vinfo:type_name -> ZInfoVolume
	52,  // 96: ZInfoMsg.cinfo:type_name -> ZInfoContentTree
	54,  // 97: ZInfoMsg.binfo:type_name -> ZInfoBlobList
	50,  // 98: ZInfoMsg.cipherinfo:type_name -> ZInfoCipher
	60,  // 99: ZInfoMsg.atTimeStamp:type_name -> google.protobuf.Timestamp
	24,  // 100: ZInfoConfigItemStatus.ConfigItemsEntry.value:type_name -> ZInfoConfigItem
	24,  // 101: ZInfoConfigItemStatus.UnknownConfigItemsEntry.value:type_name -> ZInfoConfigItem
