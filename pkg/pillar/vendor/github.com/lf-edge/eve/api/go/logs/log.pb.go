...
var file_logs_log_proto_rawDesc = []byte{
	...
	0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x42, 0x39, 0x0a, 0x13, 0x6f, 0x72,
	0x67, 0x2e, 0x6c, 0x66, 0x65, 0x64, 0x67, 0x65, 0x2e, 0x65, 0x76, 0x65, 0x2e, 0x6c, 0x6f, 0x67,
	0x73, 0x5a, 0x22, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6c, 0x66,
...
var file_logs_log_proto_goTypes = []interface{}{
	...
	nil,                          // 3: org.lfedge.eve.logs.LogEntry.TagsEntry
	(*timestamp.Timestamp)(nil),  // 4: google.protobuf.Timestamp
}
var file_logs_log_proto_depIdxs = []int32{
	3, // 0: org.lfedge.eve.logs.LogEntry.tags:type_name -> org.lfedge.eve.logs.LogEntry.TagsEntry
	4, // 1: org.lfedge.eve.logs.LogEntry.timestamp:type_name -> google.protobuf.Timestamp
	0, // 2: org.lfedge.eve.logs.LogBundle.log:type_name -> org.lfedge.eve.logs.LogEntry
	4, // 3: org.lfedge.eve.logs.LogBundle.timestamp:type_name -> google.protobuf.Timestamp
	0, // 4: org.lfedge.eve.logs.AppInstanceLogBundle.log:type_name -> org.lfedge.eve.logs.LogEntry
	4, // 5: org.lfedge.eve.logs.AppInstanceLogBundle.timestamp:type_name -> google.protobuf.Timestamp
