...
type SystemAdapter struct {
	...
	// Access Point Address or ID, used in Wifi SSID or LTE APN
	AccessPoint          string   `protobuf:"bytes,9,opt,name=accessPoint,proto3" json:"accessPoint,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *SystemAdapter) GetAccessPoint() string {
	if m != nil {
...
var fileDescriptor_9fb58492383773ea = []byte{
	...
	,
}
