...
type BackupStatusApplyConfiguration struct {
	...
	State                  *longhornv1beta1.BackupState `json:"state,omitempty"`
...
func (b *BackupStatusApplyConfiguration) WithState(value longhornv1beta1.BackupState) *BackupStatusApplyConfiguration {
	b.State = &value
	return b
}
