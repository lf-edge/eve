...
type ShareManagerStatusApplyConfiguration struct {
	...
	State    *longhornv1beta1.ShareManagerState `json:"state,omitempty"`
...
func (b *ShareManagerStatusApplyConfiguration) WithState(value longhornv1beta1.ShareManagerState) *ShareManagerStatusApplyConfiguration {
	b.State = &value
	return b
}
