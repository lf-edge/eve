...
type EngineSpecApplyConfiguration struct {
	...
	RequestedDataSource       *longhornv1beta1.VolumeDataSource `json:"requestedDataSource,omitempty"`
...
func (b *EngineSpecApplyConfiguration) WithFrontend(value longhornv1beta1.VolumeFrontend) *EngineSpecApplyConfiguration {
	b.Frontend = &value
	return b
}
...
func (b *EngineSpecApplyConfiguration) WithRequestedDataSource(value longhornv1beta1.VolumeDataSource) *EngineSpecApplyConfiguration {
