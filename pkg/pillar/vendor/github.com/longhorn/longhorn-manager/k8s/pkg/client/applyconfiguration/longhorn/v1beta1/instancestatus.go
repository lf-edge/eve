...
type InstanceStatusApplyConfiguration struct {
	...
	CurrentState        *longhornv1beta1.InstanceState `json:"currentState,omitempty"`
...
func (b *InstanceStatusApplyConfiguration) WithCurrentState(value longhornv1beta1.InstanceState) *InstanceStatusApplyConfiguration {
