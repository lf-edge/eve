...
type InstanceSpecApplyConfiguration struct {
	...
	DesireState      *longhornv1beta1.InstanceState `json:"desireState,omitempty"`
...
func (b *InstanceSpecApplyConfiguration) WithDesireState(value longhornv1beta1.InstanceState) *InstanceSpecApplyConfiguration {
	b.DesireState = &value
	return b
}
