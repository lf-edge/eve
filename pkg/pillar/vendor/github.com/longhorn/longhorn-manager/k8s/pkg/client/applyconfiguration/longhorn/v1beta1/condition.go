...
type ConditionApplyConfiguration struct {
	...
	Status             *longhornv1beta1.ConditionStatus `json:"status,omitempty"`
...
func (b *ConditionApplyConfiguration) WithStatus(value longhornv1beta1.ConditionStatus) *ConditionApplyConfiguration {
	b.Status = &value
	return b
}
