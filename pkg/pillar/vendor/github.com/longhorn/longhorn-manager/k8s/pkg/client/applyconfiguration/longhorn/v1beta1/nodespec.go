...
type NodeSpecApplyConfiguration struct {
	...
	EngineManagerCPURequest  *int                                  `json:"engineManagerCPURequest,omitempty"`
	ReplicaManagerCPURequest *int                                  `json:"replicaManagerCPURequest,omitempty"`
}
...
// WithEngineManagerCPURequest sets the EngineManagerCPURequest field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the EngineManagerCPURequest field is set to the value of the last call.
func (b *NodeSpecApplyConfiguration) WithEngineManagerCPURequest(value int) *NodeSpecApplyConfiguration {
	b.EngineManagerCPURequest = &value
	return b
}

// WithReplicaManagerCPURequest sets the ReplicaManagerCPURequest field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the ReplicaManagerCPURequest field is set to the value of the last call.
func (b *NodeSpecApplyConfiguration) WithReplicaManagerCPURequest(value int) *NodeSpecApplyConfiguration {
	b.ReplicaManagerCPURequest = &value
	return b
}
