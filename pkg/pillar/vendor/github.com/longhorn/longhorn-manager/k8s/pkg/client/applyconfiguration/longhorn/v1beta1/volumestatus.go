...
type VolumeStatusApplyConfiguration struct {
	...
	State              *longhornv1beta1.VolumeState           `json:"state,omitempty"`
	Robustness         *longhornv1beta1.VolumeRobustness      `json:"robustness,omitempty"`
	...
	ShareState         *longhornv1beta1.ShareManagerState     `json:"shareState,omitempty"`
}
...
func (b *VolumeStatusApplyConfiguration) WithState(value longhornv1beta1.VolumeState) *VolumeStatusApplyConfiguration {
	b.State = &value
	return b
}
...
func (b *VolumeStatusApplyConfiguration) WithRobustness(value longhornv1beta1.VolumeRobustness) *VolumeStatusApplyConfiguration {
	b.Robustness = &value
	return b
}
...
func (b *VolumeStatusApplyConfiguration) WithConditions(entries map[string]ConditionApplyConfiguration) *VolumeStatusApplyConfiguration {
...
func (b *VolumeStatusApplyConfiguration) WithShareState(value longhornv1beta1.ShareManagerState) *VolumeStatusApplyConfiguration {
	b.ShareState = &value
	return b
}
