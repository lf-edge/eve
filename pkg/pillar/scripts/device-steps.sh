...
FIRSTBOOT=
AGENTS="diag zedagent ledmanager nim nodeagent domainmgr loguploader tpmmgr vaultmgr zedmanager zedrouter downloader verifier baseosmgr zedkube wstunnelclient volumemgr watcher zfsmanager"
