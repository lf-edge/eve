...
// tls.go contains helper functions for manipulating with AuthContainer in cloudconn.
...
// ClearCloudCert - zero out cached cloud certs.
func (c *Client) ClearCloudCert() {
