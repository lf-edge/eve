...
// ClientOptions. The returned Client manages connections to the controller or cloud,
...
// RequestOptions defines per-request configuration flags for cloudconn Client methods.
...
// Note: with cloudconn.Client created, it is more efficient to call Client.UseV2API().
func UseV2API() bool {
