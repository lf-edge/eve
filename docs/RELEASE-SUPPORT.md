...
An LTS line receives security fixes and LTS point releases for **24 months** from the date
the line became generally available. After that the line reaches **end of support** and
receives no further fixes. Existing artifacts remain downloadable.

This is the support the Project EVE community provides. A downstream vendor may offer
different support for its EVE-based product, such as a longer period or a different scope;
that offer is the vendor's to state.
...
| Line | First `-lts` release | Support start | Status | End of support |
| --- | --- | --- | --- | --- |
| `master` | n/a | n/a | Development. Not for production, no security support. | n/a |
| 17.0.x | `17.0.0-lts`, 2026-07-27 | 2026-07-28 | Supported | 2028-07-28 |
| 16.0.x | `16.0.0-lts`, 2026-01-07 | 2026-01-07 | Supported | 2028-01-07 |
| 14.5.x | `14.5.0-lts`, 2025-06-18 | 2025-06-18 | Supported | 2027-06-18 |
| 13.4.x | `13.4.0-lts`, 2024-12-28 | 2024-12-28 | Supported | 2026-12-28 |
| 12.0.x | `12.0.2-lts`, 2024-06-12 | 2024-06-12 | End of support | 2026-06-12 |
| 11.0.x | `11.0.2-lts`, 2023-12-15 | 2023-11-30 | End of support | 2025-11-30 |
| 10.4.x | `10.4.5-lts`, 2023-10-27 | 2023-09-30 | End of support | 2025-09-30 |

A line absent from this table has reached end of support.
...
end of support, so an operator can still obtain the last build of an unsupported line. Continued
...
- **The support end dates above are the project's, not yours.** A vendor's support period is
  set by the vendor, based on how long its product is expected to be in use, and may be
  longer than the upstream line's.
...
commercially. Members receive the advisory **two weeks** before publication, so they can have
their own advisory ready on the day. Membership requires a named security contact who agrees
to hold embargoed information until the disclosure date.
