...
Every installation ends with a verification stage that records a hardware inventory and tests networking, storage and the TPM. See [HARDWARE-VERIFICATION](./HARDWARE-VERIFICATION.md) for what it collects and how to retrieve the results.
