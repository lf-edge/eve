...
| Vault Encryption | Lock/unlock vault |  | Sealed to TPM PCRs  | [Encrypted Data Store](SECURITY-ARCHITECTURE.md#encrypted-data-store) |
| Vault Encryption | Backup for upgrades |  | Encrypted and sent to controller  | [Encrypted Data Store](SECURITY-ARCHITECTURE.md#encrypted-data-store) |
