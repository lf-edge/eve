...
1. The Makefile runs `tools/compose-image-yml.sh -b images/rootfs.yml.in -v "$(ROOTFS_VERSION)-$(HV)-$(ZARCH)" -h $(HV) -o images/rootfs-$(HV).yml.in images/rootfs-$(HV).yml.in.yq`, i.e. the utility [compose-image-yml.sh](../tools/compose-image-yml.sh), passing it:
   ...
   * one or more modifiers; currently only `images/rootfs-$(HV).yml.in.yq`, with the filename generated by the Makefile
