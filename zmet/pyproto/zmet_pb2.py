...
_ZINFODEVICE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='softwaraList', full_name='ZInfoDevice.softwaraList', index=10,
...
_ZINFODEVICE.fields_by_name['softwaraList'].message_type = _ZINFOSW
