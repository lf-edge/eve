...
.PHONY: all clean test run pkgs help live rootfs config installer live current bootstrap_rootfs pkgs_rootfs multi_rootfs cache-images FORCE $(DIST) HOSTARCH image-set cache-export
FORCE:
