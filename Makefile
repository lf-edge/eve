...
bump-eve-libs:
	find . -type f -name "go.mod" -exec grep -q 'github.com/lf-edge/eve-libs' {} \; -execdir go get github.com/lf-edge/eve-libs@14.5-stable \; -execdir go mod tidy \; -execdir go mod vendor \;
