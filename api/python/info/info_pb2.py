...
_DATASECATREST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='vaultList', full_name='DataSecAtRest.vaultList', index=0,
