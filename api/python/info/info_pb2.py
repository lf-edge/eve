...
_ZINFODEVICE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='hwSecurityModule', full_name='ZInfoDevice.hwSecurityModule', index=19,
