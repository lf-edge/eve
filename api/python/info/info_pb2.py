...
_STORAGESERVICECMD = _descriptor.Descriptor(
  name='StorageServiceCmd',
  full_name='org.lfedge.eve.info.StorageServiceCmd',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='cmd_type', full_name='org.lfedge.eve.info.StorageServiceCmd.cmd_type', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='run_type', full_name='org.lfedge.eve.info.StorageServiceCmd.run_type', index=1,
      number=2, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='last_update_time', full_name='org.lfedge.eve.info.StorageServiceCmd.last_update_time', index=2,
      number=3, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='next_run_time', full_name='org.lfedge.eve.info.StorageServiceCmd.next_run_time', index=3,
      number=4, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='last_change_cmd_run_type_time', full_name='org.lfedge.eve.info.StorageServiceCmd.last_change_cmd_run_type_time', index=4,
      number=5, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='launch_times_history_list', full_name='org.lfedge.eve.info.StorageServiceCmd.launch_times_history_list', index=5,
...
_STORAGEINFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='service_cmd_info', full_name='org.lfedge.eve.info.StorageInfo.service_cmd_info', index=11,
...
_STORAGESERVICECMD.fields_by_name['cmd_type'].enum_type = config_dot_storage__pb2._STORAGECMDTYPE
_STORAGESERVICECMD.fields_by_name['run_type'].enum_type = config_dot_storage__pb2._STORAGECMDRUNTYPE
...
_STORAGEINFO.fields_by_name['service_cmd_info'].message_type = _STORAGESERVICECMD
...
DESCRIPTOR.message_types_by_name['StorageServiceCmd'] = _STORAGESERVICECMD
...
StorageServiceCmd = _reflection.GeneratedProtocolMessageType('StorageServiceCmd', (_message.Message,), {
  'DESCRIPTOR' : _STORAGESERVICECMD,
  '__module__' : 'info.info_pb2'
  # @@protoc_insertion_point(class_scope:org.lfedge.eve.info.StorageServiceCmd)
  })
_sym_db.RegisterMessage(StorageServiceCmd)
