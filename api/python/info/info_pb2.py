...
_IPHYIOTYPE = _descriptor.EnumDescriptor(
  name='IPhyIoType',
  full_name='IPhyIoType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='IPhyIoNoop', index=0, number=0,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='IPhyIoNetEth', index=1, number=1,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='IPhyIoUSB', index=2, number=2,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='IPhyIoCOM', index=3, number=3,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='IPhyIoAudio', index=4, number=4,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='IPhyIoNetWLAN', index=5, number=5,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='IPhyIoNetWWAN', index=6, number=6,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='IPhyIoHDMI', index=7, number=7,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='IPhyIoOther', index=8, number=255,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_sym_db.RegisterEnumDescriptor(_IPHYIOTYPE)

IPhyIoType = enum_type_wrapper.EnumTypeWrapper(_IPHYIOTYPE)
_INFOPHYIOMEMBERUSAGE = _descriptor.EnumDescriptor(
  name='InfoPhyIoMemberUsage',
  full_name='InfoPhyIoMemberUsage',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='InfoPhyIoUsageNone', index=0, number=0,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='InfoPhyIoUsageMgmtAndApps', index=1, number=1,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='InfoPhyIoUsageShared', index=2, number=2,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='InfoPhyIoUsageDedicated', index=3, number=3,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='InfoPhyIoUsageDisabled', index=4, number=4,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='InfoPhyIoUsageMgmtOnly', index=5, number=5,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_sym_db.RegisterEnumDescriptor(_INFOPHYIOMEMBERUSAGE)

InfoPhyIoMemberUsage = enum_type_wrapper.EnumTypeWrapper(_INFOPHYIOMEMBERUSAGE)
...
_ZIOBUNDLE.fields_by_name['type'].enum_type = _IPHYIOTYPE
_ZIOBUNDLE.fields_by_name['ioAddressList'].message_type = _IOADDRESSES
_ZIOBUNDLE.fields_by_name['usage'].enum_type = _INFOPHYIOMEMBERUSAGE
...
_DEVICEPORT.fields_by_name['usage'].enum_type = _INFOPHYIOMEMBERUSAGE
...
DESCRIPTOR.enum_types_by_name['IPhyIoType'] = _IPHYIOTYPE
DESCRIPTOR.enum_types_by_name['InfoPhyIoMemberUsage'] = _INFOPHYIOMEMBERUSAGE
