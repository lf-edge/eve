...
_ZINFOTYPES = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='Z_INFO_TYPES_CIPHER_INFO', index=7, number=10,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_CIPHEROBJECTTYPE = _descriptor.EnumDescriptor(
  name='CipherObjectType',
  full_name='CipherObjectType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='CIPHER_OBJECT_TYPE_INVALID', index=0, number=0,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CIPHER_OBJECT_TYPE_CONTEXT', index=1, number=1,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CIPHER_OBJECT_TYPE_CONTROLLER_CERT', index=2, number=2,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CIPHER_OBJECT_TYPE_NODE_CERT', index=3, number=3,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CIPHER_OBJECT_TYPE_NIM_BLOCK', index=4, number=4,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CIPHER_OBJECT_TYPE_DOMAINMGR_BLOCK', index=5, number=5,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CIPHER_OBJECT_TYPE_DOWNLOADER_BLOCK', index=6, number=6,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_sym_db.RegisterEnumDescriptor(_CIPHEROBJECTTYPE)

CipherObjectType = enum_type_wrapper.EnumTypeWrapper(_CIPHEROBJECTTYPE)
_CIPHEROBJECTEVENT = _descriptor.EnumDescriptor(
  name='CipherObjectEvent',
  full_name='CipherObjectEvent',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='CIPHER_OBJECT_EVENT_INVALID', index=0, number=0,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CIPHER_OBJECT_EVENT_CREATE', index=1, number=1,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CIPHER_OBJECT_EVENT_DELETE', index=2, number=2,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CIPHER_OBJECT_EVENT_MODIFY', index=3, number=3,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CIPHER_OBJECT_EVENT_DECRYPT', index=4, number=4,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_sym_db.RegisterEnumDescriptor(_CIPHEROBJECTEVENT)

CipherObjectEvent = enum_type_wrapper.EnumTypeWrapper(_CIPHEROBJECTEVENT)
_CIPHEROBJECTSTATUS = _descriptor.EnumDescriptor(
  name='CipherObjectStatus',
  full_name='CipherObjectStatus',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='CIPHER_OBJECT_STATUS_INVALID', index=0, number=0,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CIPHER_OBJECT_STATUS_SUCCESS', index=1, number=1,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CIPHER_OBJECT_STATUS_ERROR', index=2, number=2,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_sym_db.RegisterEnumDescriptor(_CIPHEROBJECTSTATUS)

CipherObjectStatus = enum_type_wrapper.EnumTypeWrapper(_CIPHEROBJECTSTATUS)
...
_ZINFOCIPHER = _descriptor.Descriptor(
  name='ZInfoCipher',
  full_name='ZInfoCipher',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='ZInfoCipher.id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='type', full_name='ZInfoCipher.type', index=1,
      number=2, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='event', full_name='ZInfoCipher.event', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='status', full_name='ZInfoCipher.status', index=3,
      number=4, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='err', full_name='ZInfoCipher.err', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ZINFOMSG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cipherinfo', full_name='ZInfoMsg.cipherinfo', index=8,
      number=16, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='atTimeStamp', full_name='ZInfoMsg.atTimeStamp', index=9,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ZINFOCIPHER.fields_by_name['type'].enum_type = _CIPHEROBJECTTYPE
_ZINFOCIPHER.fields_by_name['event'].enum_type = _CIPHEROBJECTEVENT
_ZINFOCIPHER.fields_by_name['status'].enum_type = _CIPHEROBJECTSTATUS
_ZINFOCIPHER.fields_by_name['err'].message_type = _ERRORINFO
...
_ZINFOMSG.fields_by_name['cipherinfo'].message_type = _ZINFOCIPHER
...
_ZINFOMSG.oneofs_by_name['InfoContent'].fields.append(
  _ZINFOMSG.fields_by_name['cipherinfo'])
_ZINFOMSG.fields_by_name['cipherinfo'].containing_oneof = _ZINFOMSG.oneofs_by_name['InfoContent']
...
DESCRIPTOR.message_types_by_name['ZInfoCipher'] = _ZINFOCIPHER
...
DESCRIPTOR.enum_types_by_name['CipherObjectType'] = _CIPHEROBJECTTYPE
DESCRIPTOR.enum_types_by_name['CipherObjectEvent'] = _CIPHEROBJECTEVENT
DESCRIPTOR.enum_types_by_name['CipherObjectStatus'] = _CIPHEROBJECTSTATUS
...
ZInfoCipher = _reflection.GeneratedProtocolMessageType('ZInfoCipher', (_message.Message,), dict(
  DESCRIPTOR = _ZINFOCIPHER,
  __module__ = 'info.info_pb2'
  # @@protoc_insertion_point(class_scope:ZInfoCipher)
  ))
_sym_db.RegisterMessage(ZInfoCipher)
