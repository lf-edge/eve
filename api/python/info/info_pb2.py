...
_DEVICEENCRYPTIONSTATUS = _descriptor.EnumDescriptor(
  ...
  full_name='DeviceEncryptionStatus',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='ESP_TYPE_NONE', index=0, number=0,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ESP_TYPE_RESTDATA', index=1, number=1,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ESP_TYPE_TRANSITDATA', index=2, number=2,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ESP_TYPE_ALLDATA', index=3, number=3,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_ZINFODEVICE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='DataEncryptionStatus', full_name='ZInfoDevice.DataEncryptionStatus', index=22,
...
_ZINFODEVICE.fields_by_name['DataEncryptionStatus'].enum_type = _DEVICEENCRYPTIONSTATUS
