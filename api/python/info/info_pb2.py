...
_ZINFOTYPES = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='ZiSnapshot', index=11, number=14,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_ZSNAPSHOTSTATE = _descriptor.EnumDescriptor(
  name='ZSnapshotState',
  full_name='org.lfedge.eve.info.ZSnapshotState',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    _descriptor.EnumValueDescriptor(
      name='Z_SNAPSHOT_STATE_UNSPECIFIED', index=0, number=0,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='Z_SNAPSHOT_STATE_CREATING', index=1, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='Z_SNAPSHOT_STATE_CREATED', index=2, number=2,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='Z_SNAPSHOT_STATE_DELETING', index=3, number=3,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='Z_SNAPSHOT_STATE_IMPLICITLY_DELETED', index=4, number=4,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_sym_db.RegisterEnumDescriptor(_ZSNAPSHOTSTATE)

ZSnapshotState = enum_type_wrapper.EnumTypeWrapper(_ZSNAPSHOTSTATE)
...
_ZINFOSNAPSHOT = _descriptor.Descriptor(
  name='ZInfoSnapshot',
  full_name='org.lfedge.eve.info.ZInfoSnapshot',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='creation_time', full_name='org.lfedge.eve.info.ZInfoSnapshot.creation_time', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='snapshot_uuid', full_name='org.lfedge.eve.info.ZInfoSnapshot.snapshot_uuid', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='volume_uuid', full_name='org.lfedge.eve.info.ZInfoSnapshot.volume_uuid', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='display_name', full_name='org.lfedge.eve.info.ZInfoSnapshot.display_name', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='encryption', full_name='org.lfedge.eve.info.ZInfoSnapshot.encryption', index=4,
      number=5, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='current_state', full_name='org.lfedge.eve.info.ZInfoSnapshot.current_state', index=5,
      number=6, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='error_msg', full_name='org.lfedge.eve.info.ZInfoSnapshot.error_msg', index=6,
      number=7, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='rollback_cmd_counter', full_name='org.lfedge.eve.info.ZInfoSnapshot.rollback_cmd_counter', index=7,
      number=8, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='rollback_time_last_op', full_name='org.lfedge.eve.info.ZInfoSnapshot.rollback_time_last_op', index=8,
      number=9, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ZINFOMSG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='snapinfo', full_name='org.lfedge.eve.info.ZInfoMsg.snapinfo', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='atTimeStamp', full_name='org.lfedge.eve.info.ZInfoMsg.atTimeStamp', index=13,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ZINFOSNAPSHOT.fields_by_name['creation_time'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
_ZINFOSNAPSHOT.fields_by_name['current_state'].enum_type = _ZSNAPSHOTSTATE
_ZINFOSNAPSHOT.fields_by_name['error_msg'].message_type = _ERRORINFO
_ZINFOSNAPSHOT.fields_by_name['rollback_time_last_op'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
...
_ZINFOMSG.fields_by_name['snapinfo'].message_type = _ZINFOSNAPSHOT
...
_ZINFOMSG.oneofs_by_name['InfoContent'].fields.append(
  _ZINFOMSG.fields_by_name['snapinfo'])
_ZINFOMSG.fields_by_name['snapinfo'].containing_oneof = _ZINFOMSG.oneofs_by_name['InfoContent']
...
DESCRIPTOR.message_types_by_name['ZInfoSnapshot'] = _ZINFOSNAPSHOT
...
DESCRIPTOR.enum_types_by_name['ZSnapshotState'] = _ZSNAPSHOTSTATE
...
ZInfoSnapshot = _reflection.GeneratedProtocolMessageType('ZInfoSnapshot', (_message.Message,), {
  'DESCRIPTOR' : _ZINFOSNAPSHOT,
  '__module__' : 'info.info_pb2'
  # @@protoc_insertion_point(class_scope:org.lfedge.eve.info.ZInfoSnapshot)
  })
_sym_db.RegisterMessage(ZInfoSnapshot)
