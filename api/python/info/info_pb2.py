...
_ZINFOAPP = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='acl_modify_time', full_name='org.lfedge.eve.info.ZInfoApp.acl_modify_time', index=11,
      number=18, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ZINFOAPP.fields_by_name['acl_modify_time'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
