...
_WIRELESSCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='CellularAPN', full_name='WirelessConfig.CellularAPN', index=1,
