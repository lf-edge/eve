...
CipherContext = _reflection.GeneratedProtocolMessageType('CipherContext', (_message.Message,), {
...
CipherBlock = _reflection.GeneratedProtocolMessageType('CipherBlock', (_message.Message,), {
...
EncryptionBlock = _reflection.GeneratedProtocolMessageType('EncryptionBlock', (_message.Message,), {
