...
_DATASTORECREDENTIALS = _descriptor.Descriptor(
  name='DatastoreCredentials',
  full_name='DatastoreCredentials',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='apiKey', full_name='DatastoreCredentials.apiKey', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='password', full_name='DatastoreCredentials.password', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DATASTORECONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='credentials', full_name='DatastoreConfig.credentials', index=7,
...
_DATASTORECONFIG.fields_by_name['credentials'].message_type = _DATASTORECREDENTIALS
...
DESCRIPTOR.message_types_by_name['DatastoreCredentials'] = _DATASTORECREDENTIALS
...
DatastoreCredentials = _reflection.GeneratedProtocolMessageType('DatastoreCredentials', (_message.Message,), dict(
  DESCRIPTOR = _DATASTORECREDENTIALS,
  __module__ = 'storage_pb2'
  # @@protoc_insertion_point(class_scope:DatastoreCredentials)
  ))
_sym_db.RegisterMessage(DatastoreCredentials)
