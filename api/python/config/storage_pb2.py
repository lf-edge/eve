...
_DSTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DsZededaS3', index=6, number=6,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DsAzureBlob', index=7, number=7,
      serialized_options=None,
      type=None),
  ],
