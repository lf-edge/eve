...
_EDGEDEVCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nodecert_confighash', full_name='EdgeDevConfig.nodecert_confighash', index=20,
