...
_EDGEDEVCONFIG.fields_by_name['lispInfo'].message_type = mesh__pb2._DEVICELISPDETAILS
_EDGEDEVCONFIG.fields_by_name['base'].message_type = baseosconfig__pb2._BASEOSCONFIG
_EDGEDEVCONFIG.fields_by_name['reboot'].message_type = devcommon__pb2._DEVICEOPSCMD
