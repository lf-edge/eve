...
_EDGEDEVCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='storage_service_cmd', full_name='org.lfedge.eve.config.EdgeDevConfig.storage_service_cmd', index=28,
...
_EDGEDEVCONFIG.fields_by_name['storage_service_cmd'].message_type = config_dot_storage__pb2._STORAGECMDCONFIG
