...
_APPINSTANCECONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='collectStatsIPAddr', full_name='AppInstanceConfig.collectStatsIPAddr', index=12,
...
_VOLUMEREF = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='uuid', full_name='VolumeRef.uuid', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='generationCount', full_name='VolumeRef.generationCount', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mount_dir', full_name='VolumeRef.mount_dir', index=2,
...
VolumeRef = _reflection.GeneratedProtocolMessageType('VolumeRef', (_message.Message,), dict(
  ...
  __module__ = 'config.appconfig_pb2'
  # @@protoc_insertion_point(class_scope:VolumeRef)
  ))
