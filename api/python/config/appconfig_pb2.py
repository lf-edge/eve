...
_SNAPSHOTDESC = _descriptor.Descriptor(
  name='SnapshotDesc',
  full_name='org.lfedge.eve.config.SnapshotDesc',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='org.lfedge.eve.config.SnapshotDesc.id', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='type', full_name='org.lfedge.eve.config.SnapshotDesc.type', index=1,
...
_SNAPSHOTCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='snapshots', full_name='org.lfedge.eve.config.SnapshotConfig.snapshots', index=3,
...
_APPINSTANCECONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='profile_list', full_name='org.lfedge.eve.config.AppInstanceConfig.profile_list', index=15,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='start_delay_in_seconds', full_name='org.lfedge.eve.config.AppInstanceConfig.start_delay_in_seconds', index=16,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='service', full_name='org.lfedge.eve.config.AppInstanceConfig.service', index=17,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='cloud_init_version', full_name='org.lfedge.eve.config.AppInstanceConfig.cloud_init_version', index=18,
...
_SNAPSHOTDESC.fields_by_name['type'].enum_type = _SNAPSHOTTYPE
_SNAPSHOTCONFIG.fields_by_name['rollback_cmd'].message_type = _INSTANCEOPSCMD
_SNAPSHOTCONFIG.fields_by_name['snapshots'].message_type = _SNAPSHOTDESC
...
DESCRIPTOR.message_types_by_name['SnapshotDesc'] = _SNAPSHOTDESC
...
SnapshotDesc = _reflection.GeneratedProtocolMessageType('SnapshotDesc', (_message.Message,), {
  'DESCRIPTOR' : _SNAPSHOTDESC,
  '__module__' : 'config.appconfig_pb2'
  # @@protoc_insertion_point(class_scope:org.lfedge.eve.config.SnapshotDesc)
  })
_sym_db.RegisterMessage(SnapshotDesc)
