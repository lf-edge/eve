...
_APPINSTANCECONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='collectStatsIPAddr', full_name='AppInstanceConfig.collectStatsIPAddr', index=13,
