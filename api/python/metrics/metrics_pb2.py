...
_URLCLOUDMETRIC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='lastUse', full_name='urlcloudMetric.lastUse', index=7,
...
_URLCLOUDMETRIC.fields_by_name['lastUse'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
