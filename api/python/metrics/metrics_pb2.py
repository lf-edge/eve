...
_DEVICEMETRIC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='last_received_config', full_name='org.lfedge.eve.metrics.deviceMetric.last_received_config', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='last_processed_config', full_name='org.lfedge.eve.metrics.deviceMetric.last_processed_config', index=15,
