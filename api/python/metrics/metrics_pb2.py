...
_LOGMETRIC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='avg_device_bundle_send_time_millis', full_name='org.lfedge.eve.metrics.logMetric.avg_device_bundle_send_time_millis', index=16,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='avg_app_bundle_send_time_millis', full_name='org.lfedge.eve.metrics.logMetric.avg_app_bundle_send_time_millis', index=17,
