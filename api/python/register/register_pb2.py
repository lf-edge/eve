...
ZRegisterMsg = _reflection.GeneratedProtocolMessageType('ZRegisterMsg', (_message.Message,), {
...
ZRegisterResp = _reflection.GeneratedProtocolMessageType('ZRegisterResp', (_message.Message,), {
