...
type UuidRequest struct {
	...
	DeviceCert []byte `protobuf:"bytes,1,opt,name=device_cert,json=deviceCert,proto3" json:"device_cert,omitempty"` //Device certificate
}
...
func (x *UuidRequest) GetDeviceCert() []byte {
	if x != nil {
		return x.DeviceCert
	}
	return nil
...
var file_uuid_uuid_proto_rawDesc = []byte{
	0x0a, 0x0f, 0x75, 0x75, 0x69, 0x64, 0x2f, 0x75, 0x75, 0x69, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x12, 0x13, 0x6f, 0x72, 0x67, 0x2e, 0x6c, 0x66, 0x65, 0x64, 0x67, 0x65, 0x2e, 0x65, 0x76,
	0x65, 0x2e, 0x75, 0x75, 0x69, 0x64, 0x22, 0x2e, 0x0a, 0x0b, 0x55, 0x75, 0x69, 0x64, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x5f,
	0x63, 0x65, 0x72, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0a, 0x64, 0x65, 0x76, 0x69,
	0x63, 0x65, 0x43, 0x65, 0x72, 0x74, 0x22, 0x69, 0x0a, 0x0c, 0x55, 0x75, 0x69, 0x64, 0x52, 0x65,
	...
	0x65, 0x42, 0x44, 0x0a, 0x13, 0x6f, 0x72, 0x67, 0x2e, 0x6c, 0x66, 0x65, 0x64, 0x67, 0x65, 0x2e,
	0x65, 0x76, 0x65, 0x2e, 0x75, 0x75, 0x69, 0x64, 0x42, 0x07, 0x45, 0x76, 0x65, 0x55, 0x75, 0x69,
	0x64, 0x50, 0x01, 0x5a, 0x22, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
	0x6c, 0x66, 0x2d, 0x65, 0x64, 0x67, 0x65, 0x2f, 0x65, 0x76, 0x65, 0x2f, 0x61, 0x70, 0x69, 0x2f,
	0x67, 0x6f, 0x2f, 0x75, 0x75, 0x69, 0x64, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_uuid_uuid_proto_rawDescOnce sync.Once
	file_uuid_uuid_proto_rawDescData = file_uuid_uuid_proto_rawDesc
)

func file_uuid_uuid_proto_rawDescGZIP() []byte {
	file_uuid_uuid_proto_rawDescOnce.Do(func() {
		file_uuid_uuid_proto_rawDescData = protoimpl.X.CompressGZIP(file_uuid_uuid_proto_rawDescData)
	})
	return file_uuid_uuid_proto_rawDescData
}

var file_uuid_uuid_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_uuid_uuid_proto_goTypes = []interface{}{
...
func file_uuid_uuid_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_uuid_uuid_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_uuid_uuid_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_uuid_uuid_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_uuid_uuid_proto_rawDesc = nil
