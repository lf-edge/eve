...
const (
	...
	ZInfoTypes_ZiSnapshot        ZInfoTypes = 14
)
...
// Snapshot states
type ZSnapshotState int32

const (
	ZSnapshotState_Z_SNAPSHOT_STATE_UNSPECIFIED ZSnapshotState = 0
	...
	ZSnapshotState_Z_SNAPSHOT_STATE_CREATING ZSnapshotState = 1
	// This state is used when the snapshot has been successfully created.
	ZSnapshotState_Z_SNAPSHOT_STATE_CREATED ZSnapshotState = 2
	// This state is used when the snapshot is pending deletion or
	// the first deletion attempt was not successful.
	ZSnapshotState_Z_SNAPSHOT_STATE_DELETING ZSnapshotState = 3
	// This state is used when the snapshot has been successfully deleted.
	// Also can get into this state when snapshots were
	// deleted automatically after the rollback command
	ZSnapshotState_Z_SNAPSHOT_STATE_DELETED ZSnapshotState = 4
)

// Enum value maps for ZSnapshotState.
var (
	ZSnapshotState_name = map[int32]string{
		0: "Z_SNAPSHOT_STATE_UNSPECIFIED",
		1: "Z_SNAPSHOT_STATE_CREATING",
		2: "Z_SNAPSHOT_STATE_CREATED",
		3: "Z_SNAPSHOT_STATE_DELETING",
		4: "Z_SNAPSHOT_STATE_DELETED",
	}
	ZSnapshotState_value = map[string]int32{
		"Z_SNAPSHOT_STATE_UNSPECIFIED": 0,
		"Z_SNAPSHOT_STATE_CREATING":    1,
		"Z_SNAPSHOT_STATE_CREATED":     2,
		"Z_SNAPSHOT_STATE_DELETING":    3,
		"Z_SNAPSHOT_STATE_DELETED":     4,
	}
)

func (x ZSnapshotState) Enum() *ZSnapshotState {
	p := new(ZSnapshotState)
	*p = x
	return p
}

func (x ZSnapshotState) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ZSnapshotState) Descriptor() protoreflect.EnumDescriptor {
	return file_info_info_proto_enumTypes[11].Descriptor()
}

func (ZSnapshotState) Type() protoreflect.EnumType {
	return &file_info_info_proto_enumTypes[11]
}

func (x ZSnapshotState) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ZSnapshotState.Descriptor instead.
func (ZSnapshotState) EnumDescriptor() ([]byte, []int) {
...
type ZInfoSnapshot struct {
	...
	CreationTime       uint64         `protobuf:"varint,1,opt,name=creation_time,json=creationTime,proto3" json:"creation_time,omitempty"` // In seconds
	Uuid               string         `protobuf:"bytes,2,opt,name=uuid,proto3" json:"uuid,omitempty"`                                      // link a command and a response. Is the real name of the snapshot in ZFS
	VolumeUuid         string         `protobuf:"bytes,3,opt,name=volume_uuid,json=volumeUuid,proto3" json:"volume_uuid,omitempty"`        // Volume ID of the volume this snapshot belongs to.
	DisplayName        string         `protobuf:"bytes,4,opt,name=display_name,json=displayName,proto3" json:"display_name,omitempty"`     // Ex: "Tuesday" or creation time (User-friendly name)
	Encryption         bool           `protobuf:"varint,5,opt,name=encryption,proto3" json:"encryption,omitempty"`
	Readonly           bool           `protobuf:"varint,6,opt,name=readonly,proto3" json:"readonly,omitempty"`                                                                     // Controls whether this dataset can be modified.
	CurrentState       ZSnapshotState `protobuf:"varint,7,opt,name=current_state,json=currentState,proto3,enum=org.lfedge.eve.info.ZSnapshotState" json:"current_state,omitempty"` // Displays the current state of the snapshot
	ErrorMsg           string         `protobuf:"bytes,8,opt,name=error_msg,json=errorMsg,proto3" json:"error_msg,omitempty"`                                                      // Ops error
	RollbackCmdCounter uint32         `protobuf:"varint,9,opt,name=rollback_cmd_counter,json=rollbackCmdCounter,proto3" json:"rollback_cmd_counter,omitempty"`                     // Counter for rollback cmd
	RollbackTimeLastOp uint64         `protobuf:"varint,10,opt,name=rollback_time_last_op,json=rollbackTimeLastOp,proto3" json:"rollback_time_last_op,omitempty"`                  // The time when the last rollback operation was performed for this snapshot
}
...
func (x *ZInfoSnapshot) GetCreationTime() uint64 {
	if x != nil {
...
func (x *ZInfoSnapshot) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
func (x *ZInfoSnapshot) GetVolumeUuid() string {
	if x != nil {
		return x.VolumeUuid
	}
	return ""
...
func (x *ZInfoSnapshot) GetDisplayName() string {
	if x != nil {
...
func (x *ZInfoSnapshot) GetEncryption() bool {
	if x != nil {
		return x.Encryption
	}
	return false
...
func (x *ZInfoSnapshot) GetReadonly() bool {
	if x != nil {
		return x.Readonly
	}
	return false
...
func (x *ZInfoSnapshot) GetCurrentState() ZSnapshotState {
	if x != nil {
		return x.CurrentState
	}
	return ZSnapshotState_Z_SNAPSHOT_STATE_UNSPECIFIED
}

func (x *ZInfoSnapshot) GetErrorMsg() string {
	if x != nil {
		return x.ErrorMsg
	}
	return ""
...
func (x *ZInfoSnapshot) GetRollbackCmdCounter() uint32 {
	if x != nil {
		return x.RollbackCmdCounter
	}
	return 0
}

func (x *ZInfoSnapshot) GetRollbackTimeLastOp() uint64 {
	if x != nil {
		return x.RollbackTimeLastOp
	}
	return 0
}
...
func (x *ZInfoMsg) GetSnapinfo() *ZInfoSnapshot {
	if x, ok := x.GetInfoContent().(*ZInfoMsg_Snapinfo); ok {
		return x.Snapinfo
	}
	return nil
}
...
type ZInfoMsg_Snapinfo struct {
	Snapinfo *ZInfoSnapshot `protobuf:"bytes,20,opt,name=snapinfo,proto3,oneof"`
}
...
func (*ZInfoMsg_Snapinfo) isZInfoMsg_InfoContent() {}
...
var file_info_info_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x69, 0x6e, 0x67, 0x22, 0x94, 0x03, 0x0a, 0x0d, 0x5a, 0x49, 0x6e, 0x66, 0x6f, 0x53,
	0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x12, 0x23, 0x0a, 0x0d, 0x63, 0x72, 0x65, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0c,
	...
	0x12, 0x1f, 0x0a, 0x0b, 0x76, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x5f, 0x75, 0x75, 0x69, 0x64, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x76, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x55, 0x75, 0x69,
	...
	,
	...
	0x75, 0x73, 0x22, 0x9d, 0x01, 0x0a, 0x09, 0x53, 0x6d, 0x61, 0x72, 0x74, 0x41, 0x74, 0x74, 0x72,
	...
	0x6f, 0x72, 0x73, 0x22, 0xfc, 0x01, 0x0a, 0x0f, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x43,
	...
	0x6d, 0x65, 0x22, 0xbd, 0x04, 0x0a, 0x0b, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x49, 0x6e,
	...
	,
	...
	0x61, 0x70, 0x74, 0x65, 0x72, 0x73, 0x12, 0x2f, 0x0a, 0x03, 0x64, 0x6e, 0x73, 0x18, 0x10, 0x20,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x6f, 0x6e, 0x52, 0x15, 0x6d, 0x61, 0x69, 0x6e, 0x74, 0x65, 0x6e, 0x61, 0x6e, 0x63, 0x65, 0x4d,
	...
	0x75, 0x6e, 0x74, 0x65, 0x72, 0x22, 0x76, 0x0a, 0x11, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x41,
	...
	0x72, 0x22, 0xdd, 0x06, 0x0a, 0x0a, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x50, 0x6f, 0x72, 0x74,
	...
	0x75, 0x6c, 0x61, 0x72, 0x22, 0xe1, 0x01, 0x0a, 0x0f, 0x5a, 0x43, 0x65, 0x6c, 0x6c, 0x75, 0x6c,
	...
	0x64, 0x65, 0x72, 0x73, 0x12, 0x21, 0x0a, 0x0c, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x5f, 0x65,
	...
	0x6f, 0x62, 0x65, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x22, 0xdc, 0x04, 0x0a, 0x0a, 0x5a, 0x49, 0x6e,
	...
	0x6e, 0x6e, 0x22, 0xd2, 0x07, 0x0a, 0x14, 0x5a, 0x49, 0x6e, 0x66, 0x6f, 0x4e, 0x65, 0x74, 0x77,
	...
	0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0xb7, 0x01, 0x0a, 0x09, 0x55, 0x73, 0x61, 0x67,
	...
	0x67, 0x65, 0x2e, 0x65, 0x76, 0x65, 0x2e, 0x69, 0x6e, 0x66, 0x6f, 0x2e, 0x5a, 0x49, 0x6e, 0x66,
	0x6f, 0x42, 0x6c, 0x6f, 0x62, 0x52, 0x04, 0x62, 0x6c, 0x6f, 0x62, 0x22, 0xd4, 0x06, 0x0a, 0x08,
	...
	0x6e, 0x66, 0x6f, 0x12, 0x40, 0x0a, 0x08, 0x73, 0x6e, 0x61, 0x70, 0x69, 0x6e, 0x66, 0x6f, 0x18,
	0x14, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x6f, 0x72, 0x67, 0x2e, 0x6c, 0x66, 0x65, 0x64,
	0x67, 0x65, 0x2e, 0x65, 0x76, 0x65, 0x2e, 0x69, 0x6e, 0x66, 0x6f, 0x2e, 0x5a, 0x49, 0x6e, 0x66,
	0x6f, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x48, 0x00, 0x52, 0x08, 0x73, 0x6e, 0x61,
	0x70, 0x69, 0x6e, 0x66, 0x6f, 0x12, 0x3c, 0x0a, 0x0b, 0x61, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x53,
	...
	,
	...
	0x52, 0x04, 0x75, 0x75, 0x69, 0x64, 0x12, 0x3c, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x28, 0x2e, 0x6f, 0x72, 0x67, 0x2e, 0x6c, 0x66, 0x65, 0x64, 0x67,
	0x65, 0x2e, 0x65, 0x76, 0x65, 0x2e, 0x69, 0x6e, 0x66, 0x6f, 0x2e, 0x41, 0x70, 0x70, 0x49, 0x6e,
	0x73, 0x74, 0x4d, 0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04,
	0x74, 0x79, 0x70, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xc5, 0x01, 0x0a, 0x0d, 0x5a, 0x49, 0x6e,
	0x66, 0x6f, 0x45, 0x64, 0x67, 0x65, 0x76, 0x69, 0x65, 0x77, 0x12, 0x3b, 0x0a, 0x0b, 0x65, 0x78,
	...
	0x69, 0x72, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x3d, 0x0a, 0x0c, 0x73, 0x74, 0x61, 0x72, 0x74,
	...
	0x65, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f,
	0x64, 0x65, 0x76, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	0x44, 0x65, 0x76, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x61, 0x70, 0x70,
	...
	0x6f, 0x67, 0x69, 0x63, 0x61, 0x6c, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x2a, 0x75, 0x0a, 0x11, 0x44,
	...
	0x10, 0x03, 0x2a, 0xcf, 0x01, 0x0a, 0x0a, 0x5a, 0x49, 0x6e, 0x66, 0x6f, 0x54, 0x79, 0x70, 0x65,
	...
	0x6f, 0x6e, 0x10, 0x0d, 0x12, 0x0e, 0x0a, 0x0a, 0x5a, 0x69, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68,
	0x6f, 0x74, 0x10, 0x0e, 0x2a, 0xf4, 0x02, 0x0a, 0x08, 0x5a, 0x53, 0x77, 0x53, 0x74, 0x61, 0x74,
	...
	0x54, 0x5f, 0x44, 0x45, 0x4c, 0x41, 0x59, 0x45, 0x44, 0x10, 0x16, 0x2a, 0x99, 0x02, 0x0a, 0x06,
	...
	0x53, 0x41, 0x42, 0x4c, 0x45, 0x44, 0x10, 0x02, 0x2a, 0xc5, 0x01, 0x0a, 0x0d, 0x5a, 0x53, 0x69,
	...
	,
	...
	0x42, 0x45, 0x5f, 0x43, 0x4f, 0x4e, 0x46, 0x49, 0x47, 0x10, 0x01, 0x2a, 0x61, 0x0a, 0x0c, 0x57,
...
var file_info_info_proto_goTypes = []interface{}{
	...
	(ZSnapshotState)(0),               // 11: org.lfedge.eve.info.ZSnapshotState
	(ZDeviceState)(0),                 // 12: org.lfedge.eve.info.ZDeviceState
	...
	(*ZInfoSnapshot)(nil),             // 47: org.lfedge.eve.info.ZInfoSnapshot
...
var file_info_info_proto_depIdxs = []int32{
	...
	11,  // 24: org.lfedge.eve.info.ZInfoSnapshot.current_state:type_name -> org.lfedge.eve.info.ZSnapshotState
	89,  // 25: org.lfedge.eve.info.StorageDiskState.disk_name:type_name -> org.lfedge.eve.common.DiskDescription
	13,  // 26: org.lfedge.eve.info.StorageDiskState.status:type_name -> org.lfedge.eve.info.StorageStatus
	49,  // 27: org.lfedge.eve.info.SmartMetric.reallocated_sector_ct:type_name -> org.lfedge.eve.info.SmartAttr
	49,  // 28: org.lfedge.eve.info.SmartMetric.power_on_hours:type_name -> org.lfedge.eve.info.SmartAttr
	49,  // 29: org.lfedge.eve.info.SmartMetric.power_cycle_count:type_name -> org.lfedge.eve.info.SmartAttr
	49,  // 30: org.lfedge.eve.info.SmartMetric.reallocated_event_count:type_name -> org.lfedge.eve.info.SmartAttr
	49,  // 31: org.lfedge.eve.info.SmartMetric.current_pending_sector:type_name -> org.lfedge.eve.info.SmartAttr
	49,  // 32: org.lfedge.eve.info.SmartMetric.temperature:type_name -> org.lfedge.eve.info.SmartAttr
	50,  // 33: org.lfedge.eve.info.StorageDiskInfo.smart_data:type_name -> org.lfedge.eve.info.SmartMetric
	14,  // 34: org.lfedge.eve.info.StorageChildren.current_raid:type_name -> org.lfedge.eve.info.StorageRaidType
	48,  // 35: org.lfedge.eve.info.StorageChildren.disks:type_name -> org.lfedge.eve.info.StorageDiskState
	52,  // 36: org.lfedge.eve.info.StorageChildren.children:type_name -> org.lfedge.eve.info.StorageChildren
	15,  // 37: org.lfedge.eve.info.StorageInfo.storage_type:type_name -> org.lfedge.eve.info.StorageTypeInfo
	14,  // 38: org.lfedge.eve.info.StorageInfo.current_raid:type_name -> org.lfedge.eve.info.StorageRaidType
	13,  // 39: org.lfedge.eve.info.StorageInfo.storage_state:type_name -> org.lfedge.eve.info.StorageStatus
	48,  // 40: org.lfedge.eve.info.StorageInfo.disks:type_name -> org.lfedge.eve.info.StorageDiskState
	52,  // 41: org.lfedge.eve.info.StorageInfo.children:type_name -> org.lfedge.eve.info.StorageChildren
	51,  // 42: org.lfedge.eve.info.ZInfoHardware.disks:type_name -> org.lfedge.eve.info.StorageDiskInfo
	30,  // 43: org.lfedge.eve.info.ZInfoDevice.minfo:type_name -> org.lfedge.eve.info.ZInfoManufacturer
	31,  // 44: org.lfedge.eve.info.ZInfoDevice.network:type_name -> org.lfedge.eve.info.ZInfoNetwork
	28,  // 45: org.lfedge.eve.info.ZInfoDevice.assignableAdapters:type_name -> org.lfedge.eve.info.ZioBundle
	33,  // 46: org.lfedge.eve.info.ZInfoDevice.dns:type_name -> org.lfedge.eve.info.ZInfoDNS
	64,  // 47: org.lfedge.eve.info.ZInfoDevice.storageList:type_name -> org.lfedge.eve.info.ZInfoStorage
	88,  // 48: org.lfedge.eve.info.ZInfoDevice.bootTime:type_name -> google.protobuf.Timestamp
	63,  // 49: org.lfedge.eve.info.ZInfoDevice.swList:type_name -> org.lfedge.eve.info.ZInfoDevSW
	25,  // 50: org.lfedge.eve.info.ZInfoDevice.metricItems:type_name -> org.lfedge.eve.info.deprecatedMetricItem
	88,  // 51: org.lfedge.eve.info.ZInfoDevice.lastRebootTime:type_name -> google.protobuf.Timestamp
	56,  // 52: org.lfedge.eve.info.ZInfoDevice.systemAdapter:type_name -> org.lfedge.eve.info.SystemAdapterInfo
	5,   // 53: org.lfedge.eve.info.ZInfoDevice.HSMStatus:type_name -> org.lfedge.eve.info.HwSecurityModuleStatus
	38,  // 54: org.lfedge.eve.info.ZInfoDevice.dataSecAtRestInfo:type_name -> org.lfedge.eve.info.DataSecAtRest
	39,  // 55: org.lfedge.eve.info.ZInfoDevice.sec_info:type_name -> org.lfedge.eve.info.SecurityInfo
	41,  // 56: org.lfedge.eve.info.ZInfoDevice.configItemStatus:type_name -> org.lfedge.eve.info.ZInfoConfigItemStatus
	42,  // 57: org.lfedge.eve.info.ZInfoDevice.appInstances:type_name -> org.lfedge.eve.info.ZInfoAppInstance
	16,  // 58: org.lfedge.eve.info.ZInfoDevice.last_boot_reason:type_name -> org.lfedge.eve.info.BootReason
	45,  // 59: org.lfedge.eve.info.ZInfoDevice.cell_radios:type_name -> org.lfedge.eve.info.ZCellularModuleInfo
	44,  // 60: org.lfedge.eve.info.ZInfoDevice.sims:type_name -> org.lfedge.eve.info.ZSimcardInfo
	43,  // 61: org.lfedge.eve.info.ZInfoDevice.tasks:type_name -> org.lfedge.eve.info.ZInfoDeviceTasks
	17,  // 62: org.lfedge.eve.info.ZInfoDevice.maintenance_mode_reason:type_name -> org.lfedge.eve.info.MaintenanceModeReason
	80,  // 63: org.lfedge.eve.info.ZInfoDevice.capabilities:type_name -> org.lfedge.eve.info.Capabilities
	12,  // 64: org.lfedge.eve.info.ZInfoDevice.state:type_name -> org.lfedge.eve.info.ZDeviceState
	17,  // 65: org.lfedge.eve.info.ZInfoDevice.maintenance_mode_reasons:type_name -> org.lfedge.eve.info.MaintenanceModeReason
	53,  // 66: org.lfedge.eve.info.ZInfoDevice.storage_info:type_name -> org.lfedge.eve.info.StorageInfo
	57,  // 67: org.lfedge.eve.info.SystemAdapterInfo.status:type_name -> org.lfedge.eve.info.DevicePortStatus
	88,  // 68: org.lfedge.eve.info.DevicePortStatus.timePriority:type_name -> google.protobuf.Timestamp
	88,  // 69: org.lfedge.eve.info.DevicePortStatus.lastFailed:type_name -> google.protobuf.Timestamp
	88,  // 70: org.lfedge.eve.info.DevicePortStatus.lastSucceeded:type_name -> google.protobuf.Timestamp
	58,  // 71: org.lfedge.eve.info.DevicePortStatus.ports:type_name -> org.lfedge.eve.info.DevicePort
	59,  // 72: org.lfedge.eve.info.DevicePort.proxy:type_name -> org.lfedge.eve.info.ProxyStatus
	33,  // 73: org.lfedge.eve.info.DevicePort.dns:type_name -> org.lfedge.eve.info.ZInfoDNS
	32,  // 74: org.lfedge.eve.info.DevicePort.location:type_name -> org.lfedge.eve.info.GeoLoc
	35,  // 75: org.lfedge.eve.info.DevicePort.err:type_name -> org.lfedge.eve.info.ErrorInfo
	87,  // 76: org.lfedge.eve.info.DevicePort.usage:type_name -> org.lfedge.eve.common.PhyIoMemberUsage
	61,  // 77: org.lfedge.eve.info.DevicePort.wireless_status:type_name -> org.lfedge.eve.info.WirelessStatus
	60,  // 78: org.lfedge.eve.info.ProxyStatus.proxies:type_name -> org.lfedge.eve.info.ProxyEntry
	19,  // 79: org.lfedge.eve.info.WirelessStatus.type:type_name -> org.lfedge.eve.info.WirelessType
	62,  // 80: org.lfedge.eve.info.WirelessStatus.cellular:type_name -> org.lfedge.eve.info.ZCellularStatus
	46,  // 81: org.lfedge.eve.info.ZCellularStatus.providers:type_name -> org.lfedge.eve.info.ZCellularProvider
	2,   // 82: org.lfedge.eve.info.ZInfoDevSW.status:type_name -> org.lfedge.eve.info.ZSwState
	35,  // 83: org.lfedge.eve.info.ZInfoDevSW.swErr:type_name -> org.lfedge.eve.info.ErrorInfo
	20,  // 84: org.lfedge.eve.info.ZInfoDevSW.userStatus:type_name -> org.lfedge.eve.info.BaseOsStatus
	21,  // 85: org.lfedge.eve.info.ZInfoDevSW.subStatus:type_name -> org.lfedge.eve.info.BaseOsSubStatus
	34,  // 86: org.lfedge.eve.info.ZInfoApp.softwareList:type_name -> org.lfedge.eve.info.ZInfoSW
	88,  // 87: org.lfedge.eve.info.ZInfoApp.bootTime:type_name -> google.protobuf.Timestamp
	28,  // 88: org.lfedge.eve.info.ZInfoApp.assignedAdapters:type_name -> org.lfedge.eve.info.ZioBundle
	35,  // 89: org.lfedge.eve.info.ZInfoApp.appErr:type_name -> org.lfedge.eve.info.ErrorInfo
	2,   // 90: org.lfedge.eve.info.ZInfoApp.state:type_name -> org.lfedge.eve.info.ZSwState
	31,  // 91: org.lfedge.eve.info.ZInfoApp.network:type_name -> org.lfedge.eve.info.ZInfoNetwork
	22,  // 92: org.lfedge.eve.info.ZInfoVpnLink.state:type_name -> org.lfedge.eve.info.ZInfoVpnState
	66,  // 93: org.lfedge.eve.info.ZInfoVpnLink.lInfo:type_name -> org.lfedge.eve.info.ZInfoVpnLinkInfo
	66,  // 94: org.lfedge.eve.info.ZInfoVpnLink.rInfo:type_name -> org.lfedge.eve.info.ZInfoVpnLinkInfo
	22,  // 95: org.lfedge.eve.info.ZInfoVpnConn.state:type_name -> org.lfedge.eve.info.ZInfoVpnState
	68,  // 96: org.lfedge.eve.info.ZInfoVpnConn.lInfo:type_name -> org.lfedge.eve.info.ZInfoVpnEndPoint
	68,  // 97: org.lfedge.eve.info.ZInfoVpnConn.rInfo:type_name -> org.lfedge.eve.info.ZInfoVpnEndPoint
	67,  // 98: org.lfedge.eve.info.ZInfoVpnConn.links:type_name -> org.lfedge.eve.info.ZInfoVpnLink
	69,  // 99: org.lfedge.eve.info.ZInfoVpn.conn:type_name -> org.lfedge.eve.info.ZInfoVpnConn
	88,  // 100: org.lfedge.eve.info.ZInfoNetworkInstance.upTimeStamp:type_name -> google.protobuf.Timestamp
	34,  // 101: org.lfedge.eve.info.ZInfoNetworkInstance.softwareList:type_name -> org.lfedge.eve.info.ZInfoSW
	26,  // 102: org.lfedge.eve.info.ZInfoNetworkInstance.ipAssignments:type_name -> org.lfedge.eve.info.ZmetIPAssignmentEntry
	27,  // 103: org.lfedge.eve.info.ZInfoNetworkInstance.vifs:type_name -> org.lfedge.eve.info.ZmetVifInfo
	28,  // 104: org.lfedge.eve.info.ZInfoNetworkInstance.assignedAdapters:type_name -> org.lfedge.eve.info.ZioBundle
	70,  // 105: org.lfedge.eve.info.ZInfoNetworkInstance.vinfo:type_name -> org.lfedge.eve.info.ZInfoVpn
	35,  // 106: org.lfedge.eve.info.ZInfoNetworkInstance.networkErr:type_name -> org.lfedge.eve.info.ErrorInfo
	23,  // 107: org.lfedge.eve.info.ZInfoNetworkInstance.state:type_name -> org.lfedge.eve.info.ZNetworkInstanceState
	88,  // 108: org.lfedge.eve.info.UsageInfo.createTime:type_name -> google.protobuf.Timestamp
	88,  // 109: org.lfedge.eve.info.UsageInfo.lastRefcountChangeTime:type_name -> google.protobuf.Timestamp
	72,  // 110: org.lfedge.eve.info.ZInfoVolume.usage:type_name -> org.lfedge.eve.info.UsageInfo
	73,  // 111: org.lfedge.eve.info.ZInfoVolume.resources:type_name -> org.lfedge.eve.info.VolumeResources
	2,   // 112: org.lfedge.eve.info.ZInfoVolume.state:type_name -> org.lfedge.eve.info.ZSwState
	35,  // 113: org.lfedge.eve.info.ZInfoVolume.volumeErr:type_name -> org.lfedge.eve.info.ErrorInfo
	75,  // 114: org.lfedge.eve.info.ZInfoContentTree.resources:type_name -> org.lfedge.eve.info.ContentResources
	72,  // 115: org.lfedge.eve.info.ZInfoContentTree.usage:type_name -> org.lfedge.eve.info.UsageInfo
	2,   // 116: org.lfedge.eve.info.ZInfoContentTree.state:type_name -> org.lfedge.eve.info.ZSwState
	35,  // 117: org.lfedge.eve.info.ZInfoContentTree.err:type_name -> org.lfedge.eve.info.ErrorInfo
	75,  // 118: org.lfedge.eve.info.ZInfoBlob.resources:type_name -> org.lfedge.eve.info.ContentResources
	72,  // 119: org.lfedge.eve.info.ZInfoBlob.usage:type_name -> org.lfedge.eve.info.UsageInfo
	2,   // 120: org.lfedge.eve.info.ZInfoBlob.state:type_name -> org.lfedge.eve.info.ZSwState
	35,  // 121: org.lfedge.eve.info.ZInfoBlob.err:type_name -> org.lfedge.eve.info.ErrorInfo
	77,  // 122: org.lfedge.eve.info.ZInfoBlobList.blob:type_name -> org.lfedge.eve.info.ZInfoBlob
	1,   // 123: org.lfedge.eve.info.ZInfoMsg.ztype:type_name -> org.lfedge.eve.info.ZInfoTypes
	55,  // 124: org.lfedge.eve.info.ZInfoMsg.dinfo:type_name -> org.lfedge.eve.info.ZInfoDevice
	65,  // 125: org.lfedge.eve.info.ZInfoMsg.ainfo:type_name -> org.lfedge.eve.info.ZInfoApp
	71,  // 126: org.lfedge.eve.info.ZInfoMsg.niinfo:type_name -> org.lfedge.eve.info.ZInfoNetworkInstance
	74,  // 127: org.lfedge.eve.info.ZInfoMsg.vinfo:type_name -> org.lfedge.eve.info.ZInfoVolume
	76,  // 128: org.lfedge.eve.info.ZInfoMsg.cinfo:type_name -> org.lfedge.eve.info.ZInfoContentTree
	78,  // 129: org.lfedge.eve.info.ZInfoMsg.binfo:type_name -> org.lfedge.eve.info.ZInfoBlobList
	81,  // 130: org.lfedge.eve.info.ZInfoMsg.amdinfo:type_name -> org.lfedge.eve.info.ZInfoAppInstMetaData
	82,  // 131: org.lfedge.eve.info.ZInfoMsg.evinfo:type_name -> org.lfedge.eve.info.ZInfoEdgeview
	54,  // 132: org.lfedge.eve.info.ZInfoMsg.hwinfo:type_name -> org.lfedge.eve.info.ZInfoHardware
	83,  // 133: org.lfedge.eve.info.ZInfoMsg.locinfo:type_name -> org.lfedge.eve.info.ZInfoLocation
	47,  // 134: org.lfedge.eve.info.ZInfoMsg.snapinfo:type_name -> org.lfedge.eve.info.ZInfoSnapshot
	88,  // 135: org.lfedge.eve.info.ZInfoMsg.atTimeStamp:type_name -> google.protobuf.Timestamp
	18,  // 136: org.lfedge.eve.info.ZInfoAppInstMetaData.type:type_name -> org.lfedge.eve.info.AppInstMetaDataType
	88,  // 137: org.lfedge.eve.info.ZInfoEdgeview.expire_time:type_name -> google.protobuf.Timestamp
	88,  // 138: org.lfedge.eve.info.ZInfoEdgeview.started_time:type_name -> google.protobuf.Timestamp
	88,  // 139: org.lfedge.eve.info.ZInfoLocation.utc_timestamp:type_name -> google.protobuf.Timestamp
	24,  // 140: org.lfedge.eve.info.ZInfoLocation.horizontal_reliability:type_name -> org.lfedge.eve.info.LocReliability
	24,  // 141: org.lfedge.eve.info.ZInfoLocation.vertical_reliability:type_name -> org.lfedge.eve.info.LocReliability
	40,  // 142: org.lfedge.eve.info.ZInfoConfigItemStatus.ConfigItemsEntry.value:type_name -> org.lfedge.eve.info.ZInfoConfigItem
	40,  // 143: org.lfedge.eve.info.ZInfoConfigItemStatus.UnknownConfigItemsEntry.value:type_name -> org.lfedge.eve.info.ZInfoConfigItem
