...
// Needs to have a separate name than the one in devmodel.proto
// XXX Remove this once we can import from config/devmodel.proto
...
// Needs to have a separate name than the one in devmodel.proto
// XXX Remove this once we can import from config/devmodel.proto
// InfoPhyIoMemberUsage - Indicates how each adaptor must be used by Eve.
type InfoPhyIoMemberUsage int32

const (
	InfoPhyIoMemberUsage_InfoPhyIoUsageNone InfoPhyIoMemberUsage = 0
	// Used by both management and apps.
	InfoPhyIoMemberUsage_InfoPhyIoUsageMgmtAndApps InfoPhyIoMemberUsage = 1
	// Shared by multiple apps
	InfoPhyIoMemberUsage_InfoPhyIoUsageShared InfoPhyIoMemberUsage = 2
	// used by only one app
	InfoPhyIoMemberUsage_InfoPhyIoUsageDedicated InfoPhyIoMemberUsage = 3
	// Adapter Blocked. Do not use the Adapter.
	InfoPhyIoMemberUsage_InfoPhyIoUsageDisabled InfoPhyIoMemberUsage = 4
	// Used for Management traffic only. Cannot be used by Apps.
	InfoPhyIoMemberUsage_InfoPhyIoUsageMgmtOnly InfoPhyIoMemberUsage = 5
)

var InfoPhyIoMemberUsage_name = map[int32]string{
	0: "InfoPhyIoUsageNone",
	1: "InfoPhyIoUsageMgmtAndApps",
	2: "InfoPhyIoUsageShared",
	3: "InfoPhyIoUsageDedicated",
	4: "InfoPhyIoUsageDisabled",
	5: "InfoPhyIoUsageMgmtOnly",
}

var InfoPhyIoMemberUsage_value = map[string]int32{
	"InfoPhyIoUsageNone":        0,
	"InfoPhyIoUsageMgmtAndApps": 1,
	"InfoPhyIoUsageShared":      2,
	"InfoPhyIoUsageDedicated":   3,
	"InfoPhyIoUsageDisabled":    4,
	"InfoPhyIoUsageMgmtOnly":    5,
}

func (x InfoPhyIoMemberUsage) String() string {
	return proto.EnumName(InfoPhyIoMemberUsage_name, int32(x))
}

func (InfoPhyIoMemberUsage) EnumDescriptor() ([]byte, []int) {
...
type ZioBundle struct {
	...
	Usage                InfoPhyIoMemberUsage `protobuf:"varint,7,opt,name=usage,proto3,enum=InfoPhyIoMemberUsage" json:"usage,omitempty"`
...
func (m *ZioBundle) GetUsage() InfoPhyIoMemberUsage {
	if m != nil {
		return m.Usage
	}
	return InfoPhyIoMemberUsage_InfoPhyIoUsageNone
}

func (m *ZioBundle) GetErr() *ErrorInfo {
	if m != nil {
		return m.Err
	}
	return nil
...
func (m *ZInfoAppInstance) Reset()         { *m = ZInfoAppInstance{} }
func (m *ZInfoAppInstance) String() string { return proto.CompactTextString(m) }
func (*ZInfoAppInstance) ProtoMessage()    {}
func (*ZInfoAppInstance) Descriptor() ([]byte, []int) {
	return fileDescriptor_f140d5b28dddb141, []int{15}
}

func (m *ZInfoAppInstance) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ZInfoAppInstance.Unmarshal(m, b)
}
func (m *ZInfoAppInstance) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ZInfoAppInstance.Marshal(b, m, deterministic)
}
func (m *ZInfoAppInstance) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ZInfoAppInstance.Merge(m, src)
}
func (m *ZInfoAppInstance) XXX_Size() int {
	return xxx_messageInfo_ZInfoAppInstance.Size(m)
}
func (m *ZInfoAppInstance) XXX_DiscardUnknown() {
	xxx_messageInfo_ZInfoAppInstance.DiscardUnknown(m)
}

var xxx_messageInfo_ZInfoAppInstance proto.InternalMessageInfo

func (m *ZInfoAppInstance) GetUuid() string {
	if m != nil {
		return m.Uuid
	}
	return ""
...
func (m *ZInfoAppInstance) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *ZInfoAppInstance) GetDomainName() string {
	if m != nil {
		return m.DomainName
	}
	return ""
...
func (m *ZInfoDevice) GetAppInstances() []*ZInfoAppInstance {
	if m != nil {
...
func (m *ZInfoDevice) GetRebootConfigCounter() uint32 {
	if m != nil {
		return m.RebootConfigCounter
	}
	return 0
}
...
type DevicePort struct {
	...
	Usage                InfoPhyIoMemberUsage `protobuf:"varint,30,opt,name=usage,proto3,enum=InfoPhyIoMemberUsage" json:"usage,omitempty"`
	NetworkUUID          string               `protobuf:"bytes,31,opt,name=networkUUID,proto3" json:"networkUUID,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (m *DevicePort) GetUsage() InfoPhyIoMemberUsage {
	if m != nil {
		return m.Usage
	}
	return InfoPhyIoMemberUsage_InfoPhyIoUsageNone
...
func (m *DevicePort) GetNetworkUUID() string {
	if m != nil {
...
func init() {
	...
	proto.RegisterEnum("InfoPhyIoMemberUsage", InfoPhyIoMemberUsage_name, InfoPhyIoMemberUsage_value)
	...
	proto.RegisterType((*ZInfoAppInstance)(nil), "ZInfoAppInstance")
...
var fileDescriptor_f140d5b28dddb141 = []byte{
	...
	,
}
