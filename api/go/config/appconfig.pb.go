...
type AppInstanceConfig struct {
	...
	// UUID of volumes to be attached to the app-instance.
	// The order here is critical because they are presented to the VM or
	// container in the order they are listed, e.g., the first VM image
	// will be the root disk.
	VolumeRefs []string `protobuf:"bytes,14,rep,name=volumeRefs,proto3" json:"volumeRefs,omitempty"`
	// the UUID of the NetworkAdapter which App Container stats collection
	// uses. If the UUID is valid, the NetworkAdapter IP address is statically
	// configured from the zedcloud.
	CollectStatsNetworkID string `protobuf:"bytes,15,opt,name=collectStatsNetworkID,proto3" json:"collectStatsNetworkID,omitempty"`
}
...
func (x *AppInstanceConfig) GetVolumeRefs() []string {
	if x != nil {
		return x.VolumeRefs
	}
	return nil
...
func (x *AppInstanceConfig) GetCollectStatsNetworkID() string {
	if x != nil {
		return x.CollectStatsNetworkID
	}
	return ""
}
...
var file_config_appconfig_proto_rawDesc = []byte{
	...
	0xcc, 0x04, 0x0a, 0x11, 0x41, 0x70, 0x70, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x43,
	...
	0x70, 0x68, 0x65, 0x72, 0x44, 0x61, 0x74, 0x61, 0x12, 0x1e, 0x0a, 0x0a, 0x76, 0x6f, 0x6c, 0x75,
	0x6d, 0x65, 0x52, 0x65, 0x66, 0x73, 0x18, 0x0e, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0a, 0x76, 0x6f,
	0x6c, 0x75, 0x6d, 0x65, 0x52, 0x65, 0x66, 0x73, 0x12, 0x34, 0x0a, 0x15, 0x63, 0x6f, 0x6c, 0x6c,
	0x65, 0x63, 0x74, 0x53, 0x74, 0x61, 0x74, 0x73, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x49,
	0x44, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x09, 0x52, 0x15, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74,
	0x53, 0x74, 0x61, 0x74, 0x73, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x49, 0x44, 0x42, 0x3d,
...
var file_config_appconfig_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_config_appconfig_proto_goTypes = []interface{}{
	...
	(*UUIDandVersion)(nil),    // 2: UUIDandVersion
	(*VmConfig)(nil),          // 3: VmConfig
	(*Drive)(nil),             // 4: Drive
	(*NetworkAdapter)(nil),    // 5: NetworkAdapter
	(*Adapter)(nil),           // 6: Adapter
	(*CipherBlock)(nil),       // 7: CipherBlock
}
var file_config_appconfig_proto_depIdxs = []int32{
	2, // 0: AppInstanceConfig.uuidandversion:type_name -> UUIDandVersion
	3, // 1: AppInstanceConfig.fixedresources:type_name -> VmConfig
	4, // 2: AppInstanceConfig.drives:type_name -> Drive
	5, // 3: AppInstanceConfig.interfaces:type_name -> NetworkAdapter
	6, // 4: AppInstanceConfig.adapters:type_name -> Adapter
	0, // 5: AppInstanceConfig.restart:type_name -> InstanceOpsCmd
	0, // 6: AppInstanceConfig.purge:type_name -> InstanceOpsCmd
	7, // 7: AppInstanceConfig.cipherData:type_name -> CipherBlock
