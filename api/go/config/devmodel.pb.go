...
type PhysicalIO struct {
	...
	// list of virtual functions for given physical function only applies for PHY_IO_TYPE_PHY_IO_NET_ETH_PF
...
type VfList struct {
	...
	VfCount uint32 `protobuf:"varint,1,opt,name=vfCount,proto3" json:"vfCount,omitempty"`
	// configured VF
...
var file_config_devmodel_proto_rawDesc = []byte{
	...
	0x38, 0x01, 0x22, 0x54, 0x0a, 0x06, 0x56, 0x66, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x18, 0x0a, 0x07,
	0x76, 0x66, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x76,
