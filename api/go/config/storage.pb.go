...
const (
	StorageCmdType_STORAGE_CMD_TYPE_UNSPECIFIED StorageCmdType = 0
	StorageCmdType_STORAGE_CMD_TYPE_TRIM        StorageCmdType = 1 // Command for Trim ops
	StorageCmdType_STORAGE_CMD_TYPE_SCRUB       StorageCmdType = 2 // Command for Scrub ops
)

// Enum value maps for StorageCmdType.
var (
	StorageCmdType_name = map[int32]string{
		0: "STORAGE_CMD_TYPE_UNSPECIFIED",
		1: "STORAGE_CMD_TYPE_TRIM",
		2: "STORAGE_CMD_TYPE_SCRUB",
	}
	StorageCmdType_value = map[string]int32{
...
func (x StorageCmdType) Enum() *StorageCmdType {
	p := new(StorageCmdType)
	*p = x
	return p
}

func (x StorageCmdType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (StorageCmdType) Descriptor() protoreflect.EnumDescriptor {
	return file_config_storage_proto_enumTypes[8].Descriptor()
}

func (StorageCmdType) Type() protoreflect.EnumType {
	return &file_config_storage_proto_enumTypes[8]
}

func (x StorageCmdType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use StorageCmdType.Descriptor instead.
func (StorageCmdType) EnumDescriptor() ([]byte, []int) {
...
const (
	StorageCmdRunType_STORAGE_CMD_RUN_TYPE_UNSPECIFIED    StorageCmdRunType = 0
	StorageCmdRunType_STORAGE_CMD_RUN_TYPE_NOT_RUN        StorageCmdRunType = 1
	StorageCmdRunType_STORAGE_CMD_RUN_TYPE_NOW            StorageCmdRunType = 2
	StorageCmdRunType_STORAGE_CMD_RUN_TYPE_EVERY_HOUR     StorageCmdRunType = 3
	StorageCmdRunType_STORAGE_CMD_RUN_TYPE_EVERY_3_HOURS  StorageCmdRunType = 4
	StorageCmdRunType_STORAGE_CMD_RUN_TYPE_EVERY_6_HOURS  StorageCmdRunType = 5
	StorageCmdRunType_STORAGE_CMD_RUN_TYPE_EVERY_12_HOURS StorageCmdRunType = 6
	StorageCmdRunType_STORAGE_CMD_RUN_TYPE_EVERY_DAY      StorageCmdRunType = 7
	StorageCmdRunType_STORAGE_CMD_RUN_TYPE_EVERY_2_DAYS   StorageCmdRunType = 8
	StorageCmdRunType_STORAGE_CMD_RUN_TYPE_EVERY_3_DAYS   StorageCmdRunType = 9
	StorageCmdRunType_STORAGE_CMD_RUN_TYPE_EVERY_WEEK     StorageCmdRunType = 10
	StorageCmdRunType_STORAGE_CMD_RUN_TYPE_EVERY_2_WEEKS  StorageCmdRunType = 11
	StorageCmdRunType_STORAGE_CMD_RUN_TYPE_EVERY_MONTH    StorageCmdRunType = 12
	StorageCmdRunType_STORAGE_CMD_RUN_TYPE_EVERY_3_MONTHS StorageCmdRunType = 13
	StorageCmdRunType_STORAGE_CMD_RUN_TYPE_EVERY_6_MONTHS StorageCmdRunType = 14
	StorageCmdRunType_STORAGE_CMD_RUN_TYPE_EVERY_YEAR     StorageCmdRunType = 15
)

// Enum value maps for StorageCmdRunType.
var (
	StorageCmdRunType_name = map[int32]string{
		0:  "STORAGE_CMD_RUN_TYPE_UNSPECIFIED",
		1:  "STORAGE_CMD_RUN_TYPE_NOT_RUN",
		2:  "STORAGE_CMD_RUN_TYPE_NOW",
		3:  "STORAGE_CMD_RUN_TYPE_EVERY_HOUR",
		4:  "STORAGE_CMD_RUN_TYPE_EVERY_3_HOURS",
		5:  "STORAGE_CMD_RUN_TYPE_EVERY_6_HOURS",
		6:  "STORAGE_CMD_RUN_TYPE_EVERY_12_HOURS",
		7:  "STORAGE_CMD_RUN_TYPE_EVERY_DAY",
		8:  "STORAGE_CMD_RUN_TYPE_EVERY_2_DAYS",
		9:  "STORAGE_CMD_RUN_TYPE_EVERY_3_DAYS",
		10: "STORAGE_CMD_RUN_TYPE_EVERY_WEEK",
		11: "STORAGE_CMD_RUN_TYPE_EVERY_2_WEEKS",
		12: "STORAGE_CMD_RUN_TYPE_EVERY_MONTH",
		13: "STORAGE_CMD_RUN_TYPE_EVERY_3_MONTHS",
		14: "STORAGE_CMD_RUN_TYPE_EVERY_6_MONTHS",
		15: "STORAGE_CMD_RUN_TYPE_EVERY_YEAR",
	}
	StorageCmdRunType_value = map[string]int32{
...
func (x StorageCmdRunType) Enum() *StorageCmdRunType {
	p := new(StorageCmdRunType)
	*p = x
	return p
}

func (x StorageCmdRunType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (StorageCmdRunType) Descriptor() protoreflect.EnumDescriptor {
	return file_config_storage_proto_enumTypes[9].Descriptor()
}

func (StorageCmdRunType) Type() protoreflect.EnumType {
	return &file_config_storage_proto_enumTypes[9]
}

func (x StorageCmdRunType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use StorageCmdRunType.Descriptor instead.
func (StorageCmdRunType) EnumDescriptor() ([]byte, []int) {
	return file_config_storage_proto_rawDescGZIP(), []int{9}
}
...
type StorageCmdConfig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	PoolName string            `protobuf:"bytes,1,opt,name=pool_name,json=poolName,proto3" json:"pool_name,omitempty"`
	CmdType  StorageCmdType    `protobuf:"varint,2,opt,name=cmd_type,json=cmdType,proto3,enum=org.lfedge.eve.config.StorageCmdType" json:"cmd_type,omitempty"`
	RunType  StorageCmdRunType `protobuf:"varint,3,opt,name=run_type,json=runType,proto3,enum=org.lfedge.eve.config.StorageCmdRunType" json:"run_type,omitempty"`
}

func (x *StorageCmdConfig) Reset() {
	*x = StorageCmdConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_config_storage_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *StorageCmdConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StorageCmdConfig) ProtoMessage() {}

func (x *StorageCmdConfig) ProtoReflect() protoreflect.Message {
	mi := &file_config_storage_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StorageCmdConfig.ProtoReflect.Descriptor instead.
func (*StorageCmdConfig) Descriptor() ([]byte, []int) {
	return file_config_storage_proto_rawDescGZIP(), []int{9}
}

func (x *StorageCmdConfig) GetPoolName() string {
	if x != nil {
		return x.PoolName
	}
	return ""
...
func (x *StorageCmdConfig) GetCmdType() StorageCmdType {
	if x != nil {
		return x.CmdType
	}
	return StorageCmdType_STORAGE_CMD_TYPE_UNSPECIFIED
}

func (x *StorageCmdConfig) GetRunType() StorageCmdRunType {
	if x != nil {
		return x.RunType
	}
	return StorageCmdRunType_STORAGE_CMD_RUN_TYPE_UNSPECIFIED
}
...
var file_config_storage_proto_rawDesc = []byte{
	...
	,
	...
	0x07, 0x2a, 0x6b, 0x0a, 0x06, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x12, 0x0e, 0x0a, 0x0a, 0x46,
	...
	0x0d, 0x0a, 0x09, 0x43, 0x4f, 0x4e, 0x54, 0x41, 0x49, 0x4e, 0x45, 0x52, 0x10, 0x08, 0x2a, 0x47,
	0x0a, 0x06, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x12, 0x0e, 0x0a, 0x0a, 0x54, 0x67, 0x74, 0x55,
	0x6e, 0x6b, 0x6e, 0x6f, 0x77, 0x6e, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x44, 0x69, 0x73, 0x6b,
	0x10, 0x01, 0x12, 0x0a, 0x0a, 0x06, 0x4b, 0x65, 0x72, 0x6e, 0x65, 0x6c, 0x10, 0x02, 0x12, 0x0a,
	0x0a, 0x06, 0x49, 0x6e, 0x69, 0x74, 0x72, 0x64, 0x10, 0x03, 0x12, 0x0b, 0x0a, 0x07, 0x52, 0x61,
	0x6d, 0x44, 0x69, 0x73, 0x6b, 0x10, 0x04, 0x2a, 0x49, 0x0a, 0x09, 0x44, 0x72, 0x69, 0x76, 0x65,
	...
	,
...
var file_config_storage_proto_enumTypes = make([]protoimpl.EnumInfo, 10)
var file_config_storage_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_config_storage_proto_goTypes = []interface{}{
	...
	(StorageCmdType)(0),               // 8: org.lfedge.eve.config.StorageCmdType
	(StorageCmdRunType)(0),            // 9: org.lfedge.eve.config.StorageCmdRunType
	(*SignatureInfo)(nil),             // 10: org.lfedge.eve.config.SignatureInfo
	(*DatastoreConfig)(nil),           // 11: org.lfedge.eve.config.DatastoreConfig
	(*Image)(nil),                     // 12: org.lfedge.eve.config.Image
	(*Drive)(nil),                     // 13: org.lfedge.eve.config.Drive
	(*ContentTree)(nil),               // 14: org.lfedge.eve.config.ContentTree
	(*VolumeContentOrigin)(nil),       // 15: org.lfedge.eve.config.VolumeContentOrigin
	(*Volume)(nil),                    // 16: org.lfedge.eve.config.Volume
	(*DiskConfig)(nil),                // 17: org.lfedge.eve.config.DiskConfig
	(*DisksConfig)(nil),               // 18: org.lfedge.eve.config.DisksConfig
	(*StorageCmdConfig)(nil),          // 19: org.lfedge.eve.config.StorageCmdConfig
	(*CipherBlock)(nil),               // 20: org.lfedge.eve.config.CipherBlock
	(*UUIDandVersion)(nil),            // 21: org.lfedge.eve.config.UUIDandVersion
	(*evecommon.DiskDescription)(nil), // 22: org.lfedge.eve.common.DiskDescription
}
var file_config_storage_proto_depIdxs = []int32{
	...
	20, // 1: org.lfedge.eve.config.DatastoreConfig.cipherData:type_name -> org.lfedge.eve.config.CipherBlock
	21, // 2: org.lfedge.eve.config.Image.uuidandversion:type_name -> org.lfedge.eve.config.UUIDandVersion
	1,  // 3: org.lfedge.eve.config.Image.iformat:type_name -> org.lfedge.eve.config.Format
	10, // 4: org.lfedge.eve.config.Image.siginfo:type_name -> org.lfedge.eve.config.SignatureInfo
	12, // 5: org.lfedge.eve.config.Drive.image:type_name -> org.lfedge.eve.config.Image
	...
	10, // 9: org.lfedge.eve.config.ContentTree.siginfo:type_name -> org.lfedge.eve.config.SignatureInfo
	5,  // 10: org.lfedge.eve.config.VolumeContentOrigin.type:type_name -> org.lfedge.eve.config.VolumeContentOriginType
	15, // 11: org.lfedge.eve.config.Volume.origin:type_name -> org.lfedge.eve.config.VolumeContentOrigin
	4,  // 12: org.lfedge.eve.config.Volume.protocols:type_name -> org.lfedge.eve.config.VolumeAccessProtocols
	22, // 13: org.lfedge.eve.config.DiskConfig.disk:type_name -> org.lfedge.eve.common.DiskDescription
	22, // 14: org.lfedge.eve.config.DiskConfig.old_disk:type_name -> org.lfedge.eve.common.DiskDescription
	6,  // 15: org.lfedge.eve.config.DiskConfig.disk_config:type_name -> org.lfedge.eve.config.DiskConfigType
	17, // 16: org.lfedge.eve.config.DisksConfig.disks:type_name -> org.lfedge.eve.config.DiskConfig
	7,  // 17: org.lfedge.eve.config.DisksConfig.array_type:type_name -> org.lfedge.eve.config.DisksArrayType
	18, // 18: org.lfedge.eve.config.DisksConfig.children:type_name -> org.lfedge.eve.config.DisksConfig
	8,  // 19: org.lfedge.eve.config.StorageCmdConfig.cmd_type:type_name -> org.lfedge.eve.config.StorageCmdType
	9,  // 20: org.lfedge.eve.config.StorageCmdConfig.run_type:type_name -> org.lfedge.eve.config.StorageCmdRunType
...
func file_config_storage_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_config_storage_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StorageCmdConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
