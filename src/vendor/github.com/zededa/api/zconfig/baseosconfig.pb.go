...
func (*OSKeyTags) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*OSVerDetails) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func (*BaseOSConfig) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{2} }
...
func init() { proto.RegisterFile("baseosconfig.proto", fileDescriptor1) }
