...
func (DHCPType) EnumDescriptor() ([]byte, []int) { return fileDescriptor8, []int{0} }
...
func (NetworkType) EnumDescriptor() ([]byte, []int) { return fileDescriptor8, []int{1} }
...
func (*ZnetStaticDNSEntry) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{1} }
...
func (*Ipspec) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{2} }
