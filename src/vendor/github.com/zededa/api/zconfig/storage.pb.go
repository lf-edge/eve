...
func (DsType) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (Format) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func (Target) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{2} }
...
func (DriveType) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{3} }
...
func (*SignatureInfo) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*DatastoreConfig) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func (*Drive) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{3} }
...
func init() { proto.RegisterFile("storage.proto", fileDescriptor1) }
